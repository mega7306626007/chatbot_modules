...
_WORLD_COUNTRIES = {
    ...
    "united kingdom": ("United Kingdom", "Western Europe", "London",
                       ...
                       "Prime Minister Andy Burnham (since 2026); monarch King Charles III",
    ...
    "japan": ("Japan", "East Asia", "Tokyo", "Japanese yen (JPY)", "Japanese",
              "Prime Minister Sanae Takaichi (since 2025); emperor Naruhito",
    ...
    "south korea": ("South Korea", "East Asia", "Seoul", "South Korean won (KRW)",
                    "Korean", "President Lee Jae-myung (since 2025)",
