...
NN_INTENT_EXAMPLES = [
    ...
    # --- write_acrostic ---
    ("write an acrostic poem for sarah", "write_acrostic"),
...
NN_INTENT_EXAMPLES_EXTRA = [
    ...
    ("so anyway, write an acrostic poem for sarah when you get a chance", "write_acrostic"),
    ("by the way, write an acrostic poem for sarah for me", "write_acrostic"),
...
NN_INTENT_EXAMPLES_EXTRA_2 = [
    ...
    ("for real, so anyway, write an acrostic poem for sarah when you get a chance haha", "write_acrostic"),
    ("by the way, write an acrostic poem for sarah for me ok", "write_acrostic"),
