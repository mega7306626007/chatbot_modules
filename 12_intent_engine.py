    ...
    TOPICS = {
        ...
        "feelings_sad": {
            "en": ["i'm sad", "i am sad", "feeling down", "unhappy", "depressed", "feeling sad", "so sad", "really sad",
                   "i got left", "i was left", "she left me", "he left me", "left me", "broke up with me",
                   "my heart is broken", "i'm heartbroken", "heartbroken", "i got dumped", "i feel betrayed",
                   "betrayed by", "my partner left me", "it's over between us"],
        ...
        "feelings_angry_topic": {
            "en": ["i'm angry", "i am angry", "so frustrated", "this is annoying", "makes me mad", "so angry", "really angry",
                   "i'm furious", "i am furious", "i can't stand this", "this drives me crazy",
                   "i'm really upset", "i got so mad", "making me angry", "i hate this", "i'm irritated"],
            ...
            "fr": ["je suis en colère", "tellement frustré", "ça m'énerve", "je suis furieux",
                   "je ne supporte plus ça", "ça me rend fou"],
        },
        ...
        "anxiety_topic": {
            "en": ["anxiety", "anxious thoughts", "panic attack", "panicking",
                   ...
                   "can't stop thinking about it", "worried sick", "anxious right now"],
        ...
        "feelings_lonely_topic": {
            "en": ["i feel lonely", "i'm lonely", "feeling alone", "nobody to talk to", "so lonely", "really lonely",
                   "all alone", "no one understands", "i feel invisible", "left out", "isolated", "all by myself"],
            "sw": ["ninahisi upweke", "nina upweke", "sina mtu wa kuongea naye", "mimi peke yangu", "nimeachwa peke"],
            "fr": ["je me sens seul", "je suis seul", "personne à qui parler", "tout seul", "je me sens invisible"],
        },
        "stress_overwhelm_topic": {
            "en": ["i'm stressed", "i am stressed", "so stressed", "i'm so stressed", "burned out", "burnt out",
                   ...
                   "too much on my plate", "i can't handle it all", "everything is too much",
                   "i'm cracking under pressure", "i don't know how to cope"],
            "sw": ["nina msongo", "nimechoka sana", "mzigo mwingi kwangu", "shinikizo kubwa",
                   "siwezi kuvumilia tena", "nimelemewa na kazi"],
        ...
        "decision_making_topic": {
            "en": ["i can't decide", "can't decide", "torn between", "choose between",
                   "make a decision", "it's a tough choice", "hard decision",
                   "i don't know what to pick", "dilemma", "what should i choose",
                   "weighing my options", "i'm going back and forth", "can't make up my mind"],
        ...
        "curiosity_topic": {
            "en": ["i'm curious", "i wonder", "curious about", "how does it work",
                   "i've been wondering", "it makes me wonder", "i'd like to understand",
                   "what's the science behind", "how do they make", "tell me about how",
                   "i've been wondering about that"],
            "sw": ["nina hamu ya kujua", "nashangaa", "ninajiuliza", "inafanya kazi aje",
                   "nimekuwa nikijiuliza kuhusu"],
            "fr": ["je suis curieux", "je me demande", "curieux de savoir", "comment ça marche",
                   "je me posais la question", "j'aimerais comprendre"],
        },
        "rumination_topic": {
            ...
            "sw": ["naendelea kufikiria", "mawazo hayaachi", "siwezi kuisahau",
                   "mawazo yanaingia bila hiari", "akili yangu haiketi"],
            "fr": ["je ne peux pas m'empêcher d'y penser", "je repense sans cesse", "je ressasse",
                   ...
                   "mon esprit n'arrête pas d'y revenir"],
        },
        "feelings_proud_topic": {
            "en": ["i'm proud of myself", "feeling proud", "i'm proud that", "proud of my", "so proud", "really proud",
                   "i passed", "i got the job", "i did it", "i finally did it", "i got accepted",
                   "i won", "i got promoted", "i'm so proud of myself", "proud of what i did",
                   "i did something brave", "i stood up for myself"],
        ...
        "small_celebration_topic": {
            "en": ["we did it", "let's celebrate", "this calls for celebration", "cheers to that",
                   "great news", "good news", "i've got some great news", "big news", "guess what",
                   "i did something great", "i got something to celebrate"],
            ...
            "fr": ["on l'a fait", "célébrons", "ça appelle une célébration", "bonne nouvelle",
                   "j'ai de bonnes nouvelles", "j'ai fait quelque chose de super"],
        },
        ...
        "achievement_milestone_topic": {
            "en": ["reached a milestone", "hit a milestone", "big achievement", "proud milestone",
                   "i achieved", "i accomplished", "i finally reached", "i hit a goal",
                   "i completed it", "i finished the project", "i graduated"],
            ...
            "fr": ["j'ai atteint une étape importante", "grande réalisation", "j'ai accompli",
                   "je suis enfin arrivé au bout", "j'ai fini le projet", "j'ai obtenu mon diplôme"],
        },
        ...
        "feeling_stuck_topic": {
            "en": ["feeling stuck", "i feel stuck", "stuck in a rut", "not moving forward",
                   "i'm at a dead end", "i don't know where to go next", "i'm going in circles",
                   "can't seem to move forward", "feeling directionless"],
            "sw": ["ninahisi nimekwama", "nimekwama", "sisogei mbele", "sijui niende wapi"],
