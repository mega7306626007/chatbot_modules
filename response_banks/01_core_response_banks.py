...
# --- Structured advice guides (long-form, arc + direct advice) ----
# Each guide: keys{en,sw,fr} for matcher, topics[] fallback, and
# en/sw/fr content with lead/sections/questions/close/followup.
ARC_ADVICE_GUIDES = {'breakup': {'keys': {'en': ['left', 'dumped', 'broke up', 'broke up with', 'ended things', 'she left', 'he left', 'left me', 'walked away', 'abandoned', 'its over between us', "it's over between us", 'my relationship is over', 'broke my heart', 'she moved on', 'he moved on'], 'sw': ['ameniacha', 'amaniachia', 'tumeachana', 'alienda', 'siri yake', 'amenichukia', 'tumekwisha', 'alianza mwingine'], 'fr': ["m'a quitté", "m'a quittée", "s'est séparé", 'on a rompu', "c'est fini entre nous", 'il est parti', 'elle est partie', 'a rompu mon cœur', 'est passée à autre chose', 'est passé à autre chose']}, 'topics': ['feelings_sad'], 'en': {'lead': 'Being left after sharing so much with someone hurts, but you can heal by protecting your dignity, letting the feelings out, and turning your focus back to yourself.', 'sections': [{'head': 'Maintain Your Dignity', 'steps': ['Do not beg: never plead or bargain for her to stay. As people in online breakup discussions almost always agree, begging for a patch-up after a breakup undermines your dignity and only makes you look desperate.', 'Go no contact: stop texting, calling, or checking her social media. Cutting off all contact gives your brain a real chance to break the withdrawal loop of old habits.'], 'note': 'A tough but freeing rule: silence is not weakness - it is the fastest way to rebalance.'}, {'head': 'Process the Pain', 'steps': ['Cry and feel it: let yourself experience the sadness. Bottling the emotions up only drags the healing out for much longer than it needs to be.', 'Accept the truth: stop waiting or hoping she will suddenly change her mind. Accepting that the relationship has ended is what finally lets you start moving forward.'], 'note': 'Healing does not mean forgetting - it means the memory no longer controls you.'}, {'head': 'Rebuild Your Life', 'steps': ['Focus on self-improvement: channel your free time and energy into fitness, work, or new personal goals that make you proud of who you are again.', 'Lean on friends: spend time with the people who genuinely care about you and talk through your feelings instead of bottling them up alone.'], 'note': None}], 'questions': ['How long were you two together?', 'Are you having trouble avoiding contact with her?', 'Was there a clear reason, or did it feel sudden?'], 'close': 'I can give you more specific steps to help you cope.', 'followup': "Thanks for telling me. If you were together a long time, the withdrawal feeling is usually strongest in the first couple of weeks - that is your brain re-learning life without the routine, not a sign you can't handle it. For now, protect tomorrow for yourself: one small healthy habit, one real conversation with a friend, and one honest hour with your own thoughts every day."}, 'sw': {'lead': 'Kutelekezwa baada ya kushiriki kila kitu na mtu huumiza, lakini unaweza kupona kwa kuhifadhi heshima yako, kuruhusu hisia zizuke, na kurudisha mwelekeo wako kwako.', 'sections': [{'head': 'Hifadhi Heshima Yako', 'steps': ['Usiombe: usiombee msichana abaki, kwani kusihi baada ya kutungana kunaharibu hadhi yako na kunakufanya uonekane mwenye shauku mno.', 'Usiwasiliane nae: acha kutuma ujumbe, kupiga simu, au kuangalia media zake. Kuachana kabisa kunasaidia ubongo wako kuvunja mzoea wa kumfikiria.'], 'note': None}, {'head': 'Chakata Uchungu', 'steps': ['Lia na uhisi: jiruhusu uone huzuni. Kujificha hisia kunachelewesha tu kupona.', 'Kubali ukweli: acha kungojea afunguka. Kukubali uhusiano umeisha ndio mwanzo wa mbele.'], 'note': None}, {'head': 'Jenga Upya Maisha Yako', 'steps': ['Jikite kwenye maendeleo: tumia muda na nguvu zako kwenye mazoezi, kazi, au malengo mapya yanayokufanya ujivunie.', 'Tegemea marafiki: kuwa na watu wanaokujali, na zungumza hisia zako badala ya kuzificha.'], 'note': None}], 'questions': ['Mlikuwa pamoja kwa muda gani?', 'Je, una shida ya kutokuwasiliana naye?', 'Kulikuwa na sababu wazi, au ilikuwa ghafla?'], 'close': 'Naweza kukupa hatua maalum zaidi za kukusaidia kupona.', 'followup': 'Asante kwa kuniambia. Ikiwa mlikaa muda mrefu, hisia ya kumkosa ni kubwa sana wiki za kwanza. Jihifadhi kwa hatua ndogo ndogo: tabia moja nzuri, mazungumzo moja ya kweli, na saa moja ya kifikra na mwenyewe kila siku.'}, 'fr': {'lead': "Se faire quitter après avoir tout partagé avec quelqu'un fait mal, mais vous pouvez guérir en protégeant votre dignité, en laissant sortir les émotions et en ramenant le focus vers vous-même.", 'sections': [{'head': 'Gardez votre dignité', 'steps': ["Ne suppliez pas: ne plaidiez jamais pour qu'elle reste. Comme le rappellent les discussions de rupture, supplier après une séparation blesse la dignité et semble désespéré.", 'Passez en non-contact: arrêtez textos, appels et réseaux sociaux. Couper tout contact aide le cerveau à briser la boucle de manque.'], 'note': None}, {'head': 'Vivez la peine', 'steps': ['Pleurez et ressentez: laissez la tristesse se vivre. Retenir ses émotions ralentit la guérison.', "Acceptez la vérité: cessez d'attendre un retour en arrière. Accepter la fin permet enfin d'avancer."], 'note': None}, {'head': 'Reconstruisez votre vie', 'steps': ["Concentrez-vous sur vous: canalisez l'énergie vers le sport, le travail ou de nouveaux objectifs personnels.", 'Appuyez-vous sur vos amis: passez du temps avec ceux qui vous aiment et parlez plutôt que de tout garder.'], 'note': None}], 'questions': ['Depuis combien de temps étiez-vous ensemble ?', 'Avez-vous du mal à éviter tout contact avec elle ?', "Y avait-il une raison claire, ou c'était soudain ?"], 'close': 'Je peux vous donner des étapes plus précises pour vous aider.', 'followup': "Merci de me l'avoir dit. Si vous étiez ensemble depuis longtemps, le manque est le plus fort dans les premières semaines. Protégez demain pour vous : une petite habitude saine, une vraie conversation, et une heure honnête avec vos pensées chaque jour."}}, 'grief_loss': {'keys': {'en': ['died', 'passed away', 'lost a loved one', 'lost my mom', 'lost my dad', 'lost my grandmother', 'lost my grandfather', 'grieving', 'after the funeral', 'in mourning', 'loss of my father', 'loss of my mother', 'she was everything', 'he was everything'], 'sw': ['amefariki', 'aliyefariki', 'nimepoteza mpendwa', 'nimepoteza mama yangu', 'nimepoteza baba yangu', 'ninaomboleza', 'msiba', 'baada ya mazishi'], 'fr': ['est décédé', 'est décédée', "j'ai perdu un être cher", "j'ai perdu ma mère", "j'ai perdu mon père", 'je fais mon deuil', "après l'enterrement", 'elle était tout pour moi', 'il était tout pour moi']}, 'topics': ['grief_loss_topic'], 'en': {'lead': 'Losing someone you love is one of the hardest things a person goes through. Grief is not a problem to fix fast - it is a wave that needs time and gentle attention.', 'sections': [{'head': 'Make Room for the Grief', 'steps': ['Grieve your way: cry, talk, sit in silence, or remember the good times - there is no wrong way to mourn, and your pace is the right pace.', 'Name the feelings: grief often hides inside anger, numbness, guilt, or exhaustion. Naming which one is present right now takes some of its power away.'], 'note': 'What you are feeling is not weakness. Research and grief counselors agree that delayed or numbed feelings are still grief.'}, {'head': 'Stay Connected', 'steps': ['Let people in: tell one trusted person what you need today - company, silence, or help with practical things. You do not have to carry this alone.', 'Remember together: share memories and stories with family or friends. Remembering out loud keeps your loved one close without keeping you stuck.'], 'note': None}, {'head': 'Small Gentle Routines', 'steps': ['Keep basics simple: sleep, water, and something to eat on a schedule. Grief exhausts the body, and simple routines carry you through the days you cannot think.', 'Give yourself permission to also feel okay sometimes: a moment of laughter or peace is not betrayal - it is healing.'], 'note': None}], 'questions': ['Was the loss recent, or has it been building up for a while?', 'Who is around you right now that understands what you are going through?', 'What part feels heaviest today - the sadness, the guilt, or the exhaustion?'], 'close': "Tell me how the grief has been showing up, and I'll give you more specific ways to carry it.", 'followup': "Thank you for sharing that. Grief moves in waves - it can be heavy one hour and quiet the next, and both are normal. Focus on today, not on 'getting over it'. One small act of self-care and one honest conversation are enough progress for now."}, 'sw': {'lead': 'Kupoteza mtu unayempenda ni jambo gumu zaidi maishani. Huzuni si tatizo la kuharakisha, bali ni wimbi linalohitaji muda na uangalifu.', 'sections': [{'head': 'Panga Njia ya Kujieleza', 'steps': ['Omba kwa namna yako: lia, zungumza, kaa kimya, au kumbuka nyakati nzuri - hakuna njia mbaya ya kuomboleza.', 'Tambua hisia: huzuni mara nyingi hujificha ndani ya hasira, ganzi, hatia, au uchovu.'], 'note': None}, {'head': 'Usiwe Peke Yako', 'steps': ['Wasaidiane: mwambie mtu mmoja wa kuaminika unachohitaji leo - uwepo, ukimya, au msaada.', 'Kumbuka pamoja: shiriki kumbukumbu na hadithi na familia au marafiki.'], 'note': None}, {'head': 'Taratibu Ndogo za Kila Siku', 'steps': ['Zingatia mambo ya msingi: usingizi, maji, na chakula kwa ratiba. Huzuni huchosha mwili.', 'Jiruhusu pia kujisikia sawa nyakati zingine: dakika ya furaha sio usaliti wa mpendwa.'], 'note': None}], 'questions': ['Msiba ni wa hivi karibuni au umejenga muda mrefu?', 'Nani yuko karibu nawe anayeelewa kile unachopitia?', 'Ni sehemu ipi ni nzito leo - huzuni, hatia, au uchovu?'], 'close': 'Niambie jinsi huzuni inavyojidhihirisha, nami nitakupa njia maalum za kuibeba.', 'followup': 'Asante kwa kushiriki. Huzuni huja kama mawimbi - nzito saa moja na kimya nyingine, na zote ni za kawaida. Fanyia leo jambo dogo la kujitunza na mazungumzo moja ya kweli.'}, 'fr': {'lead': "Perdre quelqu'un qu'on aime est l'une des épreuves les plus dures. Le deuil n'est pas un problème à régler vite - c'est une vague qui demande du temps.", 'sections': [{'head': 'Faites de la place au deuil', 'steps': ["Vivez votre deuil à votre façon: pleurer, parler, rester silencieux ou se souvenir - il n'y a pas de mauvaise façon.", "Nommez les émotions: le deuil se cache dans la colère, l'engourdissement, la culpabilité ou l'épuisement."], 'note': None}, {'head': 'Restez connecté', 'steps': ["Laissez des gens entrer: dites à une personne de confiance ce dont vous avez besoin aujourd'hui.", 'Souvenez-vous ensemble: partagez les souvenirs avec la famille et les amis.'], 'note': None}, {'head': 'De petites routines douces', 'steps': ["Simplifiez l'essentiel: sommeil, eau et repas à heures fixes portent les jours difficiles.", "Autorisez-vous des moments de paix: un éclat de rire n'est pas une trahison, c'est se soigner."], 'note': None}], 'questions': ['La perte est-elle récente ou ancienne ?', 'Qui vous entoure et comprend ce que vous vivez ?', "Qu'est-ce qui est le plus lourd aujourd'hui : la tristesse, la culpabilité ou l'épuisement ?"], 'close': 'Dites-moi comment le deuil se manifeste, et je vous donnerai des façons plus concrètes de le porter.', 'followup': "Merci d'avoir partagé cela. Le deuil va par vagues - lourd une heure, calme l'autre, et c'est normal. Concentrez-vous sur aujourd'hui, une petite attention pour vous et une conversation honnête suffisent."}}, 'loneliness': {'keys': {'en': ['lonely', 'feel alone', 'all alone', 'nobody to talk to', 'no friends', 'so alone', 'isolated', 'invisible', 'by myself', 'no one understands me', 'i feel invisible', 'left out', 'alone in the world', 'nobody cares'], 'sw': ['upweke', 'peke yangu', 'sina rafiki', 'hakuna wa kuongea naye', 'nimeachwa peke', 'sijionei', 'hakuna anayenijali'], 'fr': ['seul', 'toute seule', 'personne à qui parler', 'sans amis', 'isolé', 'invisible', 'personne ne me comprend', 'seul au monde']}, 'topics': ['feelings_lonely_topic'], 'en': {'lead': 'Feeling lonely is not about how many people are around you - it is about feeling unseen. The good news is that loneliness responds to small, repeated connections rather than big grand gestures.', 'sections': [{'head': 'Start Tiny', 'steps': ["Reach out small: write one message to one person, even 'thinking of you'. One warm exchange is enough to break the silence.", 'Use the low-pressure moments: say hello to people you already see - the barista, a classmate, a neighbor. Small repeated contact builds real belonging.'], 'note': 'Loneliness shrinks when you move first. Most people wait to be welcomed; being the welcomer breaks the pattern.'}, {'head': "Join, Don't Just Watch", 'steps': ['Pick one recurring activity: a class, a club, a team, or volunteering. Recurring beats one-off - belonging grows with repeated presence.', "Invite once, don't overthink it: a simple 'let's grab food this week' gives others an easy way in. You do not need to be fascinating - just regularly present."], 'note': None}, {'head': 'Tend the Relationship With Yourself', 'steps': ['Distinguish aloneness from loneliness: time with yourself can be rich. Build a small ritual you genuinely enjoy alone.', "Check the inner critic: 'no one likes me' is a story, not a fact. Question that voice as if a friend said it about themselves."], 'note': None}], 'questions': ['Is it that you have no one around, or that you feel unseen by the people around you?', 'What is the easiest small contact you can make this week?', 'Have you had good friendships before that faded, or is this pattern newer?'], 'close': "Tell me about your week ahead, and I'll help you plan small steps that actually fit your life.", 'followup': 'That helps a lot. Start with contact that costs almost nothing and repeats - that is the secret ingredient. If you can manage three small hellos and one deeper conversation this week, you will already feel the difference.'}, 'sw': {'lead': 'Kuhisi upweke si kuhusu idadi ya watu walio karibu nawe, bali kuhisi kuonekana. Upweke unaweza kufifia kwa miunganiko midogo ya kurudiarudia.', 'sections': [{'head': 'Anza Kidogo Kidogo', 'steps': ["Wasiliana: andika ujumbe mmoja kwa mtu mmoja, hata 'nimekukumbuka'.", 'Tumia nyakati rahisi: salamiana na watu unaowaona kila siku.'], 'note': None}, {'head': 'Jiunge, Usitazame Tu', 'steps': ['Chagua shughuli moja ya kurudia: darasa, klabu, timu, au kujitolea.', "Alika mara moja: useme 'twende kula wiki hii' kumpa mtu njia rahisi."], 'note': None}, {'head': 'Jitunze Mwenyewe', 'steps': ['Pambanua upweke na kuwa peke yako: muda na wewe mwenyewe unaweza kuwa tajiri.', "Chunguza sauti ya ndani: 'hakuna anayenipenda' ni hadithi si kweli."], 'note': None}], 'questions': ['Je, huna mtu kabisa, au unahisi hauwezi kuonekana?', 'Ni mawasiliano gani rahisi unaweza kufanya wiki hii?', 'Je, ulikuwa na marafiki wazuri waliopotea, au mtindo huu ni mpya?'], 'close': 'Niambie juu ya wiki yako, nami nitakusaidia kupanga hatua ndogo zinazofaa.', 'followup': 'Hilo linasaidia sana. Anza na mawasiliano yasiyogharimu na yanayorudia - ndio kiini. Salamu tatu ndogo na mazungumzo moja makubwa wiki hii yatabadilisha kitu.'}, 'fr': {'lead': "Se sentir seul ne dépend pas du nombre de personnes autour de vous - c'est se sentir invisible. La solitude répond à de petits liens répétés, pas aux grands gestes.", 'sections': [{'head': 'Commencez petit', 'steps': ["Écrivez un message à une personne, même 'je pensais à toi'.", "Utilisez les moments sans pression: saluez les gens que vous voyez déjà - c'est la répétition qui crée l'appartenance."], 'note': None}, {'head': 'Rejoignez, ne regardez pas', 'steps': ['Choisissez une activité récurrente: cours, club, équipe ou bénévolat.', "Invitez simplement: 'on mange ensemble cette semaine' donne une porte d'entrée facile."], 'note': None}, {'head': 'Entretenez le lien avec vous-même', 'steps': ['Distinguer solitude et être seul: le temps seul peut être riche - créez un rituel que vous aimez.', "Questionnez le critique intérieur: 'personne ne m'aime' est une histoire, pas un fait."], 'note': None}], 'questions': ["Est-ce que vous n'avez personne, ou que vous vous sentez invisible ?", 'Quel est le contact le plus facile que vous puissiez faire cette semaine ?', 'Des amitiés fortes se sont-elles éteintes, ou ce schéma est-il récent ?'], 'close': 'Parlez-moi de votre semaine, et je vous aiderai à planifier des petits pas adaptés.', 'followup': "C'est très utile. Commencez par un contact qui coûte peu et qui se répète - c'est l'ingrédient clé. Trois petits bonjours et une vraie conversation cette semaine suffisent déjà."}}, 'sadness_mood': {'keys': {'en': ['sad', 'down', 'unhappy', 'low', 'blue', 'heavy', 'heartbroken', 'not myself', 'crying', 'tears', 'no motivation', 'feeling empty', 'everything feels heavy', 'i feel like giving up'], 'sw': ['huzuni', 'nimehuzunika', 'sina nguvu', 'nilolewa', 'nahisi tupu', 'ninalia', 'machozi', 'sina faida', 'nimechoka kiakili'], 'fr': ['triste', 'déprimé', 'mal dans ma peau', 'vide', 'je pleure', 'des larmes', 'sans motivation', 'tout est lourd']}, 'topics': ['feelings_sad', 'disappointment_topic'], 'en': {'lead': 'Sadness is not a malfunction - it is your mind telling you something matters. You are allowed to feel it fully, and you are also allowed to carry it in a way that lets you keep living.', 'sections': [{'head': "Let It Be Present, Don't Let It Take Over", 'steps': ["Name it out loud: 'I am sad' lowers the weight because it stops the sadness from being a vague fog over everything.", 'Give it a time and place: set aside 15 quiet minutes today to feel it fully; the rest of the day you get to move forward anyway.'], 'note': "Therapists describe this as 'riding the wave' - feelings peak, then pass, then return - rather than holding them off forever."}, {'head': 'Break the Weight Into Actions', 'steps': ['Do one small useful thing: shower, tidy one corner, cook one proper meal. Action on autopilot gently reminds you the world still works.', 'Change the scenery briefly: five minutes outside moves your body, your eyes, and your thoughts.'], 'note': None}, {'head': 'Choose Who You Let In', 'steps': ["Tell one person the truth: 'I am having a rough day' is enough. You do not need to perform okay.", 'Be careful with comparisons: social media shows highlight reels while you are seeing your behind-the-scenes. Offline is kinder today.'], 'note': None}], 'questions': ['Has this been a few days, or has it been building over weeks or months?', 'Is anything specific weighing on you, or is it more of a general heaviness?', 'What usually helps you, even a little - even if you have not tried it this week?'], 'close': 'Tell me a little more, and I can tailor these steps to exactly what is weighing on you.', 'followup': "That is really useful. Right now, do not aim for 'feeling better' - aim for 'keeping the day manageable'. One honest acknowledgment, one tiny action, one low-pressure person in your corner. Repeat that today, and tell me how it went."}, 'sw': {'lead': 'Huzuni sio hitilafu - ni akili yako ikisema jambo fulani ni muhimu. Unaruhusiwa kuhisi kikamilifu, na pia unaruhusiwa kuibeba kwa njia inayokuruhusu kuendelea kuishi.', 'sections': [{'head': 'Ikubali Isitawale', 'steps': ["Iseme kwa sauti: 'nina huzuni' hupunguza uzito.", 'Panga muda wa kuitosha: dakika 15 kimya leo, halafu endelea na siku.'], 'note': None}, {'head': 'Vunja Uzito Uwe Hatua', 'steps': ['Fanya jambo dogo muhimu: oga, panga kona moja, pika chakula kimoja.', 'Badilisha mandhari: dakika tano nje inabadilisha mwili na mawazo.'], 'note': None}, {'head': 'Chagua Wenye Kuagua', 'steps': ["Mwambie mtu mmoja ukweli: 'nina siku ngumu' inatosha.", 'Jihadhari na kulinganisha: media za kijamii zinaonyesha stori za utukufu tu.'], 'note': None}], 'questions': ['Hii ni siku chache au imejenga wiki/miezi?', 'Kuna jambo mahususi linakulemea, au uzito wa jumla?', 'Ni nini husaidia a little - hata kama hujajaribu wiki hii?'], 'close': 'Niambie zaidi, nami nitabadilisha hatua hizi kulingana na vile unavyopitia.', 'followup': "Hichi kinasaidia. Usilenge 'kujisikia vizuri' - lenge 'kuweka siku iwe endeleevu'. Utambuzi mmoja wa kweli, hatua moja ndogo, mtu mmoja wa kuaminika."}, 'fr': {'lead': "La tristesse n'est pas un dysfonctionnement - c'est votre esprit qui vous dit que quelque chose compte. Vous avez le droit de la ressentir, et de la porter d'une façon qui vous laisse vivre.", 'sections': [{'head': 'Laissez-la être, sans la laisser gagner', 'steps': ["Nommez-la: 'je suis triste' allège parce que la tristesse cesse d'être un brouillard.", "Donnez-lui un moment: 15 minutes calmes aujourd'hui, puis avancez quand même."], 'note': None}, {'head': 'Transformez le poids en actions', 'steps': ['Faites une petite chose utile: une douche, un coin rangé, un vrai repas.', 'Changez de décor: cinq minutes dehors changent le corps et les pensées.'], 'note': None}, {'head': 'Choisissez qui laisse entrer', 'steps': ["Dites la vérité à une personne: 'je passe une journée difficile' suffit.", 'Fuyez les comparaisons: les réseaux montrent des extraits soignés, pas les coulisses.'], 'note': None}], 'questions': ['Est-ce récent (quelques jours) ou cela se construit depuis des semaines ?', 'Y a-t-il une cause précise, ou une lourdeur générale ?', "Qu'est-ce qui vous aide d'habitude, même un peu ?"], 'close': "Dites-m'en plus, et j'adapterai ces pas à ce qui vous pèse.", 'followup': "C'est utile. Aujourd'hui, ne visez pas 'aller mieux' - visez 'tenir la journée'. Une reconnaissance honnête, une petite action, une personne fiable à vos côtés."}}, 'anger': {'keys': {'en': ['angry', 'furious', 'mad', 'so frustrated', 'infuriated', 'outraged', "i'm raging", 'this pisses me off', "i can't stand this", 'drives me crazy', 'annoyed', 'irritated', 'fed up', 'i lost my temper'], 'sw': ['hasira', 'nimekasirika', 'nina kinyongo', 'inasumbua', 'sisuburu tena', 'nimechoka na hii', 'nakera'], 'fr': ['en colère', 'furieux', 'furieuse', 'exaspéré', 'énervé', 'fou de rage', 'ça me rend fou', 'je ne supporte plus', 'agacé', 'ai assez']}, 'topics': ['feelings_angry_topic'], 'en': {'lead': 'Anger is energy - often justified energy. The goal is not to swallow it silently, but to express it with enough control that it protects you instead of costing you.', 'sections': [{'head': 'Cool the Engine First', 'steps': ['Buy ten seconds: before you answer, press the pause button. Anger peaks fast and drops fast - you only need to survive the peak.', 'Use your body to reset: slow breaths, a short walk, cold water on your face - physical resets come before logical ones.'], 'note': "As anger-management coaches often put it: 'You can't think your way out of a red-hot state - you have to cool your way out first.'"}, {'head': 'Say It Without Setting Yourself on Fire', 'steps': ["Use 'I' statements: 'I feel upset because...' lands far better than 'you always...' and keeps the conversation open.", 'Delay the big conversation: if it matters, agree to talk about it when the heat drops - same topic, cooler temperature.'], 'note': None}, {'head': "Find What It's Protecting", 'steps': ['Ask what the anger is guarding: disrespect? fear? injustice? Once you name it, you can act on the real issue.', 'Choose the action that fits: sometimes it is a firm boundary, sometimes a complaint filed, sometimes just walking away with your head high.'], 'note': None}], 'questions': ['What sparked it - one specific thing, or a build-up of many small things?', 'Is the anger about a person, a situation, or both?', 'What would need to happen for you to feel the anger is handled?'], 'close': "Tell me what set it off and I'll help you shape the most effective response.", 'followup': 'Good - that gives me the direction. Whatever the cause, the winning move is to separate the feeling from the decision: feel the anger fully, decide with a clear head. If you can answer one step later - what result you actually want - the right action gets much clearer.'}, 'sw': {'lead': 'Hasira ni nishati - mara nyingi nishati yenye haki. Lengo si kuimeza kimya, bali kuiweka chini ya udhibiti ili ikulinde badala ya kukugharimu.', 'sections': [{'head': 'Poa Kwanza', 'steps': ['Subiri sekunde kumi kabla ya kujibu - hasira hupanda na kupungua haraka.', 'Tumia mwili kurejea: pumua polepole, tembea kidogo, maji baridi usoni.'], 'note': None}, {'head': 'Sema Bila Kujidhuru', 'steps': ["Tumia maneno ya 'mimi': 'naudhika kwa sababu...' husikika vizuri kuliko 'wewe kila mara...'.", 'Ahirisha mazungumzo makubwa mpaka joto lipungue.'], 'note': None}, {'head': 'Chunguza Inalinda Nini', 'steps': ['Uliza hasira inalinda nini: heshima? hofu? udhalimu?', 'Chagua hatua inayofaa: mipaka imara, malalamiko rasmi, au kuondoka kwa utulivu.'], 'note': None}], 'questions': ['Kilichokuamsha ni kitu kimoja au mrundikano?', 'Hasira inaelekezwa kwa mtu, hali, au wote?', 'Nini kifanyike ili uone hasira imeshughulikiwa?'], 'close': 'Niambie kilichokuamsha nami nitakusaidia kuunda jibu bora zaidi.', 'followup': 'Hilo linanipa mwelekeo. Njia ya ushindi ni kutenganisha hisia na uamuzi: hisi hasira kikamilifu, lakini amua kwa utulivu.'}, 'fr': {'lead': "La colère est de l'énergie - souvent justifiée. Le but n'est pas de l'avaler, mais de l'exprimer avec assez de contrôle pour qu'elle vous protège.", 'sections': [{'head': "Refroidissez d'abord le moteur", 'steps': ['Achetez dix secondes avant de répondre - la colère monte et redescend vite.', 'Réinitialisez avec le corps: respirations lentes, marche courte, eau fraîche.'], 'note': None}, {'head': 'Dites-le sans vous brûler', 'steps': ["Utilisez le 'je': 'je me sens blessé parce que...' passe mieux que 'tu toujours...'.", 'Reportez la grande conversation à tête froide - même sujet, température plus basse.'], 'note': None}, {'head': "Trouvez ce qu'elle protège", 'steps': ['Demandez: manque de respect ? peur ? injustice ?', "Choisissez l'action qui convient: une limite ferme, un signalement, ou partir la tête haute."], 'note': None}], 'questions': ["Qu'est-ce qui l'a déclenchée - une chose, ou un cumul ?", 'Est-ce contre une personne, une situation, ou les deux ?', 'Que faudrait-il pour que la colère soit traitée ?'], 'close': 'Dites-moi la cause et je vous aiderai à construire la réponse la plus efficace.', 'followup': "Voilà la direction. La meilleure approche : séparer l'émotion de la décision - ressentez la colère pleinement, décidez avec une tête claire."}}, 'anxiety': {'keys': {'en': ['anxious', 'anxiety', 'panic', 'worried', 'on edge', 'racing thoughts', 'panic attack', 'my heart is racing', 'overthinking', 'nervous breakdown', "can't calm down", 'restless', 'worried about everything', 'catastrophizing', 'dread', 'impending doom'], 'sw': ['wasiwasi', 'hofu', 'mshtuko wa hofu', 'mawazo yanakimbia', 'sina utulivu', 'nina wasiwasi kila kitu', 'mbio za moyo'], 'fr': ['anxieux', 'anxiété', 'panique', 'inquiet', 'à cran', 'attaque de panique', "pensées qui s'emballent", "je n'arrive pas à me calmer", 'angoisse']}, 'topics': ['anxiety_topic', 'feelings_nervous_topic', 'mental_health_checkin_topic'], 'en': {'lead': "Anxiety is your alarm system stuck in the 'on' position. Right now we are not going to debate whether the worry is justified - first we slow the alarm, then we look at what it is pointing at.", 'sections': [{'head': 'Slow the Alarm', 'steps': ['Regulate the body first: slow, long exhales - breathe in for 4, out for 6, ten times. It signals the body that the emergency is over.', 'Ground in the present: name 5 things you can see, 4 you can touch, 3 you can hear. It pulls your mind out of the future and into the room.'], 'note': "Psychologists call this 'grounding' - it works because anxiety lives in the imagined future, and your senses only live in the now."}, {'head': 'Right-Size the Worry', 'steps': ['Write the worst case in one sentence, then rate the odds. Most feared outcomes are far less likely than the feeling suggests.', "Separate 'controllable' from 'not': put your energy only into the column you can act on; let the other column down for now."], 'note': None}, {'head': 'Get Ahead of It', 'steps': ['Set a worry window: give worries 10 minutes a day in writing, and outsource the rest of the day to living.', 'Cut the fuel: notice caffeine, scrolling and late-night doom reading - they feed the alarm, not the truth.'], 'note': None}], 'questions': ['When the panic spikes, are you more racing-thoughts or physical symptoms?', 'Is there one particular thing it keeps circling back to?', 'Has it been getting worse recently, or staying about the same?'], 'close': 'Tell me about your last spike and I can give you a specific plan for the moment it happens again.', 'followup': 'That narrows it down. Next time it spikes, your job is only the first ten seconds: long exhales, cold water or a grounding count - everything else waits until the alarm drops. Then, once down, we work on the actual worry instead of fighting the alarm itself.'}, 'sw': {'lead': "Wasiwasi ni kengele yako iliyokwama 'ikiwashwa'. Sasa hatujadili kama hofu ni halali - kwanza tunaipunguza kengele, halafu tunaangalia inaelekeza wapi.", 'sections': [{'head': 'Punguza Kengele', 'steps': ['Simamia mwili kwanza: pumua polepole - pumzika 4, toa 6, mara kumi.', 'Jiweke kwenye wakati sasa: taja vitu 5 unavyoona, 4 unavyogusa, 3 unavyosikia.'], 'note': None}, {'head': 'Pima Ukubwa wa Wasiwasi', 'steps': ['Andika mabaya kabisa kwa sentensi moja, kisha kadiria uwezekano wake.', "Tenganisha 'ninaweza kudhibiti' na 'siwezi' - weka nishati hanya kwenye sehemu unaweza kufanya."], 'note': None}, {'head': 'Tangulilia', 'steps': ['Weka dirisha la wasiwasi: dakika 10 kwa siku za kuandika, na achilia siku nyingine.', 'Punguza mafuta ya kengele: kahawa nyingi, kusogeza skrini, na usomaji wa usiku wa mambo ya kutisha.'], 'note': None}], 'questions': ['Panic inapopanda, ni mawazo yanayokimbia au dalili za mwili?', 'Kuna kitu kimoja kinachorudi? Ni mbaya zaidi hivi karibuni?'], 'close': 'Niambie juu ya shambulio lako la mwisho nami nitakupa mpango wa wakati unaorudi.', 'followup': 'Hilo linapunguza wigo. Wakati ujao, kazi yako ni sekunde kumi tu za kwanza: pumua polepole, maji baridi, hesabu ya kutuliza - yote mengine yanasubiri kengele ishuke.'}, 'fr': {'lead': "L'anxiété est votre alarme restée allumée. On ne va pas débattre du bien-fondé de l'inquiétude - d'abord on ralentit l'alarme, ensuite on regarde ce qu'elle montre.", 'sections': [{'head': "Ralentissez l'alarme", 'steps': ['Régulez le corps: longues expirations - inspirez 4, expirez 6, dix fois.', "Ancrez-vous: nommez 5 choses vues, 4 touchées, 3 entendues. Ça sort l'esprit du futur."], 'note': None}, {'head': "Redimensionnez l'inquiétude", 'steps': ['Écrivez le pire en une phrase puis évaluez ses chances - souvent faible.', 'Séparez le contrôlable du non-contrôlable - donnez votre énergie au premier.'], 'note': None}, {'head': 'Devancez-la', 'steps': ["Fixez une fenêtre d'inquiétude: 10 minutes par jour à écrire, le reste du temps à vivre.", 'Coupez le carburant: caféine, défilement tardif et lectures anxiogènes.'], 'note': None}], 'questions': ['Quand la panique monte, est-ce plutôt pensées ou symptômes physiques ?', 'Y a-t-il un sujet qui revient toujours ?', 'Est-ce que ça empire, ou ça reste stable ?'], 'close': "Parlez-moi de votre dernière montée d'angoisse, et je vous donnerai un plan précis pour la prochaine.", 'followup': "Voilà qui réduit le champ. La prochaine fois, votre seul travail est les dix premières secondes : longues expirations, eau fraîche, ancrage - tout le reste attend que l'alarme s'abaisse."}}, 'stress_overwhelm': {'keys': {'en': ['stressed', 'stress', 'overwhelmed', 'swamped', 'burnout', 'burned out', 'too much on my plate', 'pressure', 'deadline', 'packed schedule', "can't cope", 'drowning in work', 'cracking under pressure', 'so busy', 'everything at once'], 'sw': ['msongo', 'mkazo', 'nimezidiwa', 'mzigo mwingi', 'shinikizo', 'sina nafasi', 'kazi nyingi', 'nimechoka sana'], 'fr': ['stressé', 'stress', 'dépassé', 'débordé', 'burn-out', 'surcharge', 'trop de pression', 'échéance', "je n'en peux plus", 'tout en même temps']}, 'topics': ['stress_overwhelm_topic'], 'en': {'lead': 'Stress usually does not come from one big thing - it comes from everything piling up at once. The way out is not a miracle, it is re-taking control of the small handles one by one.', 'sections': [{'head': 'Put the Brakes on the Pile', 'steps': ['Do a brain dump: write every task, worry and open loop on paper. What feels like ten thousand things usually becomes a list you can actually see and count.', "Pick the three that matter: cross off everything that can wait, and agree that the rest of the list 'belongs' to tomorrow - not to tonight's head."], 'note': "As time-management coaches say: 'You don't actually have too much to do - you have too much to do at once, and your brain is trying to do it all in parallel.'"}, {'head': 'Protect One Pocket of Peace', 'steps': ['Block a physical break: a 20-minute walk, a proper meal, or a shower with no phone. Recovery is not lost time - it is the fuel for everything else.', 'Sleep is non-negotiable: tired brains exaggerate every problem by a factor of two. Fix bedtime before fixing the to-do list.'], 'note': None}, {'head': 'Ask What the Emergency Actually Is', 'steps': ['Distinguish urgency from importance: fires feel urgent but are often small; the important-but-not-urgent work is where your life actually moves.', "Say no or ask for help: a short 'can this stretch to next week?' or 'can someone take this?' often relieves more than working harder."], 'note': None}], 'questions': ['How many plates are spinning right now - work, home, family, school?', 'Which one weighs most, and which one actually has a hard deadline?', 'When did you last take a true break - not a scrolling break?'], 'close': "List the top two things weighing on you and I'll help you make a simple plan for the next 48 hours.", 'followup': 'Good - even naming the two heaviest feels lighter. Tonight, only one thing matters: get a full night sleep and pick ONE small task to finish tomorrow. Witness the calm that one finished thing brings, then we tackle the second.'}, 'sw': {'lead': 'Msongo kwa kawaida hautoki kwa jambo moja kubwa - unakuja mambo yote yakirundikana. Njia ya kutoka si miujiza, ni kudhibiti vishikio vidogo moja moja.', 'sections': [{'head': 'Simamisha Rundo', 'steps': ['Andika kila kazi na wasiwasi kwenye karatasi - inakuwa orodha inayoonekana.', 'Chagua tatu muhimu: vunja vingine kwa kesho, si kwa akili ya leo usiku.'], 'note': None}, {'head': 'Linda Nafasi Moja ya Amani', 'steps': ['Panga mapumziko halisi: matembezi ya dakika 20, mlo kamili, kuoga bila simu.', 'Usingizi sio wa kujadiliwa: ubongo uliochoka huongeza kila tatizo maradufu.'], 'note': None}, {'head': 'Uliza Dharura Ipo Wapi', 'steps': ['Pambanua dharura na umuhimu: moto mara nyingi ni mdogo.', "Sema hapana au omba msaada: 'kunaweza kuhamishwa wiki ijayo?'"]}], 'questions': ['Mipira mingapi inazunguka sasa hivi?', 'Ni ipi nzito zaidi, na ipi ina mwisho wa muda halisi?', 'Ulipumzika kweli lini?'], 'close': 'Orodhesha mambo mawili yanayokulemea nami nitakusaidia mpango wa saa 48.', 'followup': 'Vizuri - hata kuvitaja viwili kunapunguza. Usiku huu, jambo moja tu: usingizi kamili na kazi moja ndogo ya kesho.'}, 'fr': {'lead': "Le stress vient rarement d'une seule grande chose - il vient de tout qui s'empile. La sortie n'est pas un miracle, c'est reprendre les commandes, une petite poignée à la fois.", 'sections': [{'head': 'Freinez la pile', 'steps': ['Faites un brain dump: écrivez toutes les tâches et inquiétudes - une liste visible remplace le brouillard.', 'Gardez les trois qui comptent: le reste appartient à demain, pas à votre tête ce soir.'], 'note': None}, {'head': 'Protégez une poche de paix', 'steps': ['Bloquez une vraie pause: 20 minutes de marche, un vrai repas, une douche sans téléphone.', "Le sommeil n'est pas négociable: un cerveau fatigué double chaque problème."], 'note': None}, {'head': "Demandez où est l'urgence", 'steps': ['Distinguer urgence et importance: les feux semblent urgents mais sont souvent petits.', "Dites non ou demandez de l'aide: 'ça peut attendre la semaine prochaine?' soulage plus que travailler plus."], 'note': None}], 'questions': ["Combien d'assiettes tournent en ce moment ?", 'Laquelle pèse le plus, laquelle a une vraie échéance ?', 'Quand avez-vous vraiment coupé - pas juste défilé ?'], 'close': 'Listez les deux plus gros et je vous ferai un plan simple pour 48 heures.', 'followup': 'Bien - nommer les deux plus lourds allège déjà. Ce soir, une seule chose : une vraie nuit de sommeil et une petite tâche pour demain.'}}, 'exhaustion': {'keys': {'en': ['exhausted', 'tired all the time', "can't get up", 'no energy', 'sleepy', 'need a break', 'burned out', 'drained', "can't focus", 'brain fog', 'always tired', 'wiped out'], 'sw': ['uchovu', 'nimechoka', 'usingizi', 'sina nguvu', 'nahitaji mapumziko', 'ubongo wa ledumngu'], 'fr': ['épuisé', 'fatigué tout le temps', "pas d'énergie", 'vidé', "besoin d'une pause", 'brouillard mental', 'toujours fatigué']}, 'topics': ['feelings_tired_topic_like', 'feelings_tired'], 'en': {'lead': 'Being exhausted all the time is your body filing an overdue report - and it is telling you to check fuel, sleep and load, not to push harder with the same tools.', 'sections': [{'head': 'Audit the Fuel Tank', 'steps': ['Check sleep honestly: are you getting 7-8 solid hours, or broken and late? Fixing the last hour of screen time usually fixes the morning.', 'Check water and food: a day of poor eating and caffeine feels like burnout. Real meals at regular times do more than naps.'], 'note': None}, {'head': 'Lower the Cost of Each Hour', 'steps': ['Cut the 20% that costs 80%: look at your calendar and kill or shrink the activities that drain most for least value.', 'Batch the small things: errands and mini-tasks in one block leave the rest of the day for deep work and rest.'], 'note': None}, {'head': 'Schedule Recovery Like Work', 'steps': ['Put rest on the calendar: a short walk after lunch and a no-screen evening are appointments, not leftovers.', "Ask what is taxing you emotionally too: fatigue is often emotional. One honest conversation can unload more than a week of 'just pushing through'."], 'note': None}], 'questions': ['How is your current sleep actually going - hours, quality, consistency?', 'When the week is the worst, which one thing eats most of your energy?', 'Is this mostly physical, or is some of it emotional carrying?'], 'close': "Tell me about a typical day and I'll spot the leaks that are quietly draining you.", 'followup': 'That gives me the picture. Pick your single biggest leak - usually sleep, food or one heavy obligation - and protect just that one for a week. One fixed leak beats three half-attempts.'}, 'sw': {'lead': 'Kuchoka kila mara ni ripoti ya kuchelewa kutoka kwa mwili wako - inakuambia uangalie mafuta, usingizi na mzigo, si kusukuma zaidi.', 'sections': [{'head': 'Kagua Tanki', 'steps': ['Chunguza usingizi: saa 7-8 za kweli? Ondoa skrini saa moja kabla ya kulala.', 'Chunguza chakula na maji: mlo halisi kwa wakati unafanya mengi kuliko usingizi mfupi.'], 'note': None}, {'head': 'Punguza Gharama ya Kila Saa', 'steps': ['Kata 20% inayotumia 80%: angalia ratiba yako.', 'Unganisha kazi ndogo: fanya jumla kwenye block moja.'], 'note': None}, {'head': 'Panga Kupona Kama Kazi', 'steps': ['Weka mapumziko kwenye kalenda: matembezi baada ya chakula, jioni bila skrini.', 'Uliza kinachokuchosha kihisia pia: uchovu mara nyingi ni mhemko.'], 'note': None}], 'questions': ['Usingizi wako wa sasa ukoje?', 'Wiki mbaya zaidi, ni kitu gani kinachotumia nishati yako?', 'Ni kimwili hasa, au baadhi ni kubeba kihisia?'], 'close': 'Niambie juu ya siku yako ya kawaida nami nitaona vyanzo vinavyokuvuja.', 'followup': 'Hiyo inanipa picha. Chagua vyanzo kikubwa zaidi - usingizi, chakula, au wajibu mzito - na ulinde kikao kwa wiki moja.'}, 'fr': {'lead': 'Être épuisé tout le temps est un rapport en retard de votre corps - il demande de vérifier carburant, sommeil et charge, pas de pousser plus fort.', 'sections': [{'head': 'Auditez le réservoir', 'steps': ["Vérifiez le sommeil: 7-8 heures réelles ? Enlevez l'écran une heure avant.", 'Vérifiez eau et repas: des repas réels à heures fixes font plus que les siestes.'], 'note': None}, {'head': 'Réduisez le coût de chaque heure', 'steps': ['Coupez le 20% qui coûte 80%: regardez votre agenda, supprimez ou réduisez ce qui épuise.', 'Regroupez les petites tâches en un bloc.'], 'note': None}, {'head': 'Planifiez la récupération comme du travail', 'steps': ['Mettez le repos au calendrier: marche après le déjeuner, soirée sans écran.', 'Demandez ce qui vous épulse émotionnellement aussi.'], 'note': None}], 'questions': ['Comment va vraiment votre sommeil ?', "Quand la semaine est dure, qu'est-ce qui mange le plus d'énergie ?", 'Est-ce surtout physique, ou en partie émotionnel ?'], 'close': 'Décrivez une journée type et je repérerai les fuites qui vous épuisent.', 'followup': "Voilà l'image. Choisissez votre plus grosse fuite - sommeil, nourriture ou une obligation lourde - et protégez-la seule pendant une semaine."}}, 'stuck_direction': {'keys': {'en': ['feeling stuck', 'i feel stuck', 'in a rut', 'no direction', 'at a dead end', "don't know where to go", 'going in circles', "can't move forward", 'no clarity', 'starting over', 'lost my way', 'no purpose'], 'sw': ['nimekwama', 'sisogei mbele', 'sijui niende wapi', 'nimepotea njia', 'mzunguko', 'hakuna mwelekeo'], 'fr': ['coincé', 'dans une impasse', "je n'avance pas", 'je ne sais pas où aller', 'je tourne en rond', 'perdu', 'sans direction']}, 'topics': ['feeling_stuck_topic'], 'en': {'lead': 'Feeling stuck is rarely a lack of options - it is information overload with no criteria for choosing. Movement beats certainty, so we are going to build a tiny experiment instead of a perfect plan.', 'sections': [{'head': "Name the 'Stuck On' Precisely", 'steps': ["Finish this sentence: 'I am stuck on ______.' Is it a decision, a skill, a resource, or a fear? Naming the type makes it suddenly tractable.", "Separate the fear from the fact: much 'stuck' is actually 'afraid of choosing wrong'. Write what you are actually avoiding, not what you tell yourself."], 'note': None}, {'head': 'Two Doors, Not Ten', 'steps': ['Force a choice: if you had to decide between only two options today, which two? Narrow options are decidable; a hundred are not.', "Test, don't commit: pick one option and give it a two-week, low-cost trial - a class, a project, a conversation. Experiments produce data; decisions produce debates."], 'note': "Career coaches use this rule a lot: 'Direction is revealed by moving, not by thinking about moving.'"}, {'head': 'Use the North Star Test', 'steps': ["Ask what you would regret not trying in a year: regret-avoidance is a sharper compass than 'what am I passionate about'.", 'Look at your last two good choices: what did they have in common? That pattern is often a hidden direction already.'], 'note': None}], 'questions': ['If you could not fail, what would the next month look like?', 'Is the block mostly choice paralysis, fear, or missing information?', 'What is one small thing you already know you could start tomorrow?'], 'close': "Tell me what 'moving' would even look like for you, and I'll help you shrink it into a two-week experiment.", 'followup': 'That is exactly the grip we need. Take the smallest version of that - two weeks, almost no cost - and treat it as an experiment, not a commitment. Collect the data, then we decide again with facts instead of fears.'}, 'sw': {'lead': 'Kuhisi kukwama si kukosa chaguo - ni ziada ya taarifa bila vigezo vya kuchagua. Mwendo unashinda uhakika, kwa hiyo tutaunda jaribio dogo badala ya mpango mkamilifu.', 'sections': [{'head': 'Tambua Unakwama Wapi', 'steps': ["Maliza sentensi: 'nimekwama kwenye ______.' Uamuzi? ujuzi? rasilimali? hofu?", "Tenganisha hofu na ukweli: mengi 'kukwama' ni kuogopa kuchagua vibaya."], 'note': None}, {'head': 'Milango Miwili, Si Kumi', 'steps': ['Lazimisha chaguo: ikiwa ungepaswa kuamua kati ya mbili tu leo, ni zipi?', 'Jaribu, usishikamane: chagua moja na upe majaribio ya wiki mbili.'], 'note': None}, {'head': 'Tumia Jaribio la Mwelekeo', 'steps': ['Uliza: nini ningerudi kujuta kutokujaribu mwaka ujao?', 'Angalia maamuzi mawili mazuri ya zamani: yalikuwa na kitu gani kwa pamoja?'], 'note': None}], 'questions': ['Kama usingeshindwa, mwezi ujao ungekuwa je?', 'Kibali hasa ni nini - uchaguzi, hofu, au ukosefu wa taarifa?', 'Kitu kimoja kidogo unachoweza kuanza kesho?'], 'close': "Niambie 'kusonga mbele' kungeonekana vipi kwako, nami ninakusaidia kukipunguza kwa jaribio la wiki mbili.", 'followup': 'Hicho ndicho tunachohitaji. Chukua toleo dogo - wiki mbili, gharama ndogo - na ulichukue kama jaribio, si wajibu.'}, 'fr': {'lead': "Se sentir coincé est rarement un manque d'options - c'est un excès d'informations sans critères. Le mouvement bat la certitude, alors créons une petite expérience plutôt qu'un plan parfait.", 'sections': [{'head': 'Nommez précisément le blocage', 'steps': ["Terminez: 'je suis coincé sur ______.' Décision, compétence, ressource, peur ?", "Séparez la peur du fait: beaucoup de 'coincé' est 'peur de mal choisir'."], 'note': None}, {'head': 'Deux portes, pas dix', 'steps': ['Forcez le choix: si vous deviez choisir entre deux options seulement ?', 'Testez, ne vous engagez pas: deux semaines à petit coût, comme une expérience.'], 'note': None}, {'head': "Test de l'étoile du Nord", 'steps': ['Demandez ce que vous regretteriez de ne pas avoir tenté dans un an.', "Regardez vos deux derniers bons choix: quel point commun ? C'est une direction cachée."], 'note': None}], 'questions': ['Si vous ne pouviez pas échouer, que ferait le mois prochain ?', "Le bloc est-il choix, peur ou manque d'infos ?", "Qu'est-ce que vous pourriez commencer demain, même petit ?"], 'close': "Dites-moi à quoi ressemblerait 'avancer' pour vous, et je vous aiderai à en faire une expérience de deux semaines.", 'followup': "C'est exactement ce qu'il nous faut. Prenez la version minimale - deux semaines, presque aucun coût - comme une expérience, pas un engagement."}}, 'decision': {'keys': {'en': ["can't decide", 'torn between', 'choose between', 'dilemma', 'hard choice', 'weighing my options', 'what should i choose', 'decide', 'pick one', 'go back and forth', 'make up my mind', 'stuck deciding', 'two sides'], 'sw': ['siwezi kuamua', 'nimegawanyika kati', 'chagua kati ya', 'uamuzi mgumu', 'sijui nichague nini', 'ninabadilisha nia', 'panda mbili'], 'fr': ['décider', 'partagé entre', 'choisir entre', 'dilemme', "j'hésite", 'quel choix', 'rester coincé', "les deux m'attirent"]}, 'topics': ['decision_making_topic'], 'en': {'lead': "A hard decision feels heavy because you are weighing imagined futures and none of them is certain. Good decisions are about process, not clairvoyance - so let's make the process fast and honest.", 'sections': [{'head': 'Write the Choice Down', 'steps': ['Put both options on paper with three columns: what you gain, what you risk, what you feel. Feelings are data too - write them without editing.', "Add a deadline: decisions expand to fill the time you give them. 'By Friday' forces real thought, not rumination."], 'note': None}, {'head': 'Run the Experiments', 'steps': ['Test cheaply: can either option be sampled before the full jump - a trial week, a question, a shadow day? Samples beat speculation.', 'Ask for a temperature check: tell two trusted people the choice and notice what you defend. The option you fight for is usually the one you want.'], 'note': 'A classic trick: flip a coin - not for the result, but because your reaction to the coin reveals your preference.'}, {'head': 'Commit With Bounds', 'steps': ['Choose and steer: commit, then set checkpoints. A good path chosen now beats a perfect path found never.', 'Pre-decide the exit: agree in advance what would tell you to change course. It makes commitment feel safe, not locked in.'], 'note': None}], 'questions': ['What are the two (or three) options really - stated in one line each?', 'Is there a part of you that already knows, behind the hesitation?', 'What is the real worst case of picking wrong - and can you live with it?'], 'close': "Write the options out like that and I'll help you rule them in or out one by one.", 'followup': 'Good - that is already half the decision. Now take the top two, run the cheap experiment on both this week, and come back with what you learned. Evidence, not anxiety, picks the winner.'}, 'sw': {'lead': 'Uamuzi mgumu unaonekana mzito kwa sababu unapima mustakabali wa kuwaziwa. Maamuzi mazuri yanahusu mchakato, si utabiri - tuufanye haraka na kwa ukweli.', 'sections': [{'head': 'Andika Chaguo', 'steps': ['Weka chaguo mbili kwenye karatasi na nguzo tatu: utapata nini, hatari gani, unajisikiaje.', "Weka mwisho wa muda: 'ifike Ijumaa' inalazimisha mawazo."], 'note': None}, {'head': 'Fanya Majaribio', 'steps': ['Jaribu kwa bei rahisi: wiki ya majaribio, swali, siku ya kuigiza?', 'Uliza watu wawili wa kuaminika: chaguo unalolitetea ndio unalotaka.'], 'note': None}, {'head': 'Amua Kwa Mipaka', 'steps': ['Chagua na endelea: uamuzi mzuri sasa unashinda kamili ambao hauwezi kufikiwa.', 'Tanguliza njia ya kutoka: itakusaidia kuamini bila kufungwa.'], 'note': None}], 'questions': ['Chaguzi zako ni zipi, kila moja kwa sentensi moja?', 'Kuna sehemu yako tayari inayojua?', 'Mbaya zaidi ya kuchagua vibaya ni nini?'], 'close': 'Andika chaguzi hivyo nami nitakusaidia kuzipima moja moja.', 'followup': 'Vizuri - hiyo ni nusu ya uamuzi. Chukua mbili za juu, jaribu zote mbili kwa bei rahisi wiki hii, urudi na uliyojifunza.'}, 'fr': {'lead': 'Une décision difficile semble lourde parce que vous comparez des futurs imaginaires. Les bonnes décisions sont une méthode, pas de la voyance - rendons-la rapide et honnête.', 'sections': [{'head': 'Écrivez le choix', 'steps': ['Notez les options en trois colonnes: gains, risques, ressenti. Les émotions sont des données.', "Ajoutez une échéance: 'avant vendredi' force la réflexion."], 'note': None}, {'head': 'Faites des expériences', 'steps': ["Testez à petit prix: une semaine d'essai, une question, une journée d'observation.", "Demandez un avis à deux personnes de confiance: l'option que vous défendez est souvent la bonne."], 'note': None}, {'head': 'Engagez-vous avec des limites', 'steps': ["Choisissez puis pilotez: un bon chemin choisi maintenant vaut mieux qu'un chemin parfait jamais trouvé.", "Prédéfinissez le point de sortie pour rendre l'engagement sûr."], 'note': None}], 'questions': ['Quelles sont vraiment vos options, en une ligne chacune ?', "Une part de vous sait-elle déjà, derrière l'hésitation ?", 'Quel est le vrai pire cas, et pouvez-vous le vivre ?'], 'close': 'Écrivez les options ainsi et je vous aiderai à les départager une à une.', 'followup': "Bien - c'est déjà la moitié de la décision. Prenez les deux meilleures, testez-les à petit prix cette semaine, et revenez avec ce que vous avez appris."}}, 'exam_failure': {'keys': {'en': ['failed the exam', 'failed my exam', 'failed my test', 'flunked', "didn't pass", 'failed again', 'failing', 'poor grades', 'dropped out', 'failed my course', 'messed up the exam', 'didnt do well', 'exam results'], 'sw': ['nilifeli mtihani', 'nimefeli', 'sikufaulu', 'matokeo mabaya', 'darasa lipo', 'nilikosa alama'], 'fr': ["raté l'examen", "j'ai échoué", 'échec', 'mauvaises notes', "n'ai pas réussi", 'ai raté mon test', 'notes en chute']}, 'topics': [], 'en': {'lead': 'Failing an exam feels like a verdict on your whole worth - it is not. It is one result about one moment, and it comes with real information you can use.', 'sections': [{'head': 'Process the Sting First', 'steps': ["Let the disappointment exist for a bounded time: 'I'm allowed to feel this until tonight' - then the verdict restarts from fact, not feeling.", "Delete the character attack: 'I'm stupid' is not data. The failure is about preparation, timing, or delivery - all changeable."], 'note': None}, {'head': "Diagnose, Don't Just Retry", 'steps': ["Ask what really failed: knowledge, technique, time, or nerves? The fix differs completely - more studying won't cure exam panic.", 'Get the paper back or talk to the teacher: the error breakdown is a free roadmap. Missed topics tell you exactly what to drill.'], 'note': None}, {'head': 'Rebuild With a Method', 'steps': ['Use the 30/60 method: 30 minutes of focused practice, then a 5-minute break - repeated beats one long cram.', 'Simulate the exam: timed practice under realistic conditions trains the same brain that takes the test.'], 'note': None}], 'questions': ['Was it a one-off result, or is this a pattern across subjects?', 'When you look back, what failed: the material, the timing, or the nerves?', 'Do you actually know what the gap topics are?'], 'close': "Tell me what the result breakdown looks like and I'll build you a focused recovery plan.", 'followup': "That tells me a lot. Focus only on the specific gaps, not on 'studying harder' broadly. 30 focused minutes on exactly the missed topics, timed practice under exam conditions, and a mock before the real thing - that is a plan that actually moves the score."}, 'sw': {'lead': 'Kufeli mtihani kunahisi kama hukumu juu ya thamani yako yote - siyo. Ni matokeo moja kwa wakati mmoja, yenye taarifa halisi unayoweza kutumia.', 'sections': [{'head': 'Chakata Uchungu Kwanza', 'steps': ["Ruhusu tamaa kwa muda: 'naweza kuhisi hivi mpaka leo usiku' - halafu ukweli uanze tena.", "Futa shambulio la utu: 'sina akili' si taarifa. Kufeli kunahusu maandalizi, muda, au uwasilishaji."], 'note': None}, {'head': 'Tambua, Usijaribu Tena Tu', 'steps': ['Uliza nini kilishindwa: ujuzi, mbinu, muda, au woga?', 'Pata karatasi au zungumza na mwalimu: makosa ni ramani ya bure.'], 'note': None}, {'head': 'Jenga Upya Kwa Mbinu', 'steps': ['Tumia njia 30/60: dakika 30 za mazoezi makini, pumziko 5.', 'Iga mtihani: mazoezi ya muda wa kweli huandaa ubongo unaofanya mtihani.'], 'note': None}], 'questions': ['Result ni moja au mtindo wanazuoni?', 'Nini kilishindwa: mada, muda, au woga?', 'Unajua mapungufu yako hasa?'], 'close': 'Niambie jinsi matokeo yalivyokuwa nami nitakujengea mpango wa kurejea.', 'followup': "Hicho kinanisaidia. Lenga mapungufu tu, si 'kusoma kwa bidii' kwa jumla. Dakika 30 makini juu ya mada zilizokosewa, mazoezi ya muda, na jaribio la mwisho - ndio mpango unaosonga matokeo."}, 'fr': {'lead': "Échouer à un examen ressemble à un verdict sur toute votre valeur - ce n'en est pas un. C'est un résultat, un moment, avec de vrais enseignements.", 'sections': [{'head': "Digérez d'abord la déception", 'steps': ["Laissez la déception exister un temps borné: 'je peux la ressentir jusqu'à ce soir'.", "Effacez l'attaque personnelle: 'je suis bête' n'est pas une donnée. L'échec concerne la préparation, le timing, la technique."], 'note': None}, {'head': 'Diagnostiquez, ne re-tentez pas', 'steps': ['Demandez ce qui a vraiment échoué: savoir, technique, temps ou stress ?', 'Récupérez la copie ou parlez au prof: les erreurs sont une feuille de route gratuite.'], 'note': None}, {'head': 'Reconstruisez avec méthode', 'steps': ['Méthode 30/60: 30 minutes de pratique focalisée, 5 de pause - la répétition bat le bachotage.', "Simulez l'examen: un entraînement chronométré forme le cerveau qui passera l'épreuve."], 'note': None}], 'questions': ['Un résultat isolé ou une tendance ?', "Quand vous y repensez, qu'est-ce qui a échoué ?", 'Connaissez-vous vos lacunes exactes ?'], 'close': 'Décrivez le détail des résultats et je construirai un plan de reprise ciblé.', 'followup': "C'est très parlant. Ciblez uniquement les lacunes précises. 30 minutes sur les sujets manqués, entraînement chronométré, et un exam blanc - voilà un plan qui fait bouger le score."}}, 'job_loss': {'keys': {'en': ['lost my job', 'lost my work', 'got fired', 'gotten fired', 'was fired', 'got sacked', 'laid off', 'got laid off', 'fired me', 'canned me', 'let me go', 'made redundant', 'lost my employment', 'unemployed', 'out of work', 'my contract ended', 'i quit my job', 'left my job', 'my job ended', 'i lost the job', 'dismissed from work', 'pink slip'], 'sw': ['nilipoteza kazi', 'nimefukuzwa kazi', 'walinifukuza', 'kazi imeisha', 'sina kazi tena', 'walisema waachie', 'nimeachishwa kazi', 'siko kazini', 'niliiacha kazi', 'ukatili', 'mkataba uliisha'], 'fr': ['perdu mon travail', 'perdu mon emploi', 'été licencié', 'été licenciée', 'mis à la porte', 'viré', 'virée', 'licenciement', 'au chômage', 'sans emploi', "mon contrat s'est terminé", "j'ai quitté mon travail", 'laissé tomber du travail']}, 'topics': ['disappointment_topic', 'feeling_stuck_topic'], 'en': {'lead': 'Losing a job attacks your income and your identity at the same time - that is why it hurts so much. The way back is to steady the money first and rebuild the direction second.', 'sections': [{'head': 'Land the Shock Without Panic', 'steps': ['Get it official: ask, in writing, for the reason, the last working day, and any pay or notice owed. Information is power, and it also gives you peace of mind.', 'Do nothing dramatic for 24 hours: do not fire off angry messages or sign anything major. The first day is for breathing, not for decisions.'], 'note': 'Career counselors almost always say the same thing: what you sign and say in the first days matters more than what you did to lose the job.'}, {'head': 'Protect the Finances First', 'steps': ['Know your runway: add up savings plus any severance or unemployment pay, and divide it by your monthly costs. That number - not your feelings - should steer the urgency.', 'Cut the big leaks fast: rent, subscriptions, and meals out are the biggest. One honest budget session this week buys you weeks of calm.'], 'note': None}, {'head': 'Rebuild the Next Move', 'steps': ['Take a structured job hunt: treat finding work like a job - a set number of applications or outreach calls each day beats a panic marathon once a month.', 'Update one proof of you: refresh your CV and one profile today. The act itself restores a surprising amount of confidence.'], 'note': None}], 'questions': ['Was the loss sudden, or was there a warning you saw coming?', 'How much runway do you actually have financially right now?', 'What direction do you want the next role to take?'], 'close': "Tell me about your runway and the next role you want, and I'll help you build a 30-day job-hunt plan.", 'followup': "Thanks for telling me. One day at a time - today, just do the financial math and update one thing on your CV. That quiet motion is what turns 'I lost my job' into 'my next chapter'."}, 'sw': {'lead': 'Kupoteza kazi kunaua mapato yako na utambulisho wako kwa wakati mmoja - ndiyo maana huumiza sana. Njia ya kurudi ni kuimarisha fedha kwanza, halafu kupanga mwelekeo mpya.', 'sections': [{'head': 'Kaa Shwari Mwanzoni', 'steps': ['Pata ukweli: uliza kwa maandishi sababu, siku ya mwisho ya kazi, na malipo yanayostahili. Taarifa ni nguvu.', 'Usifanye jambo kubwa kwa saa 24: usitume ujumbe wa hasira au kusaini chochote. Siku ya kwanza ni ya kupumua, si ya maamuzi.'], 'note': None}, {'head': 'Linda Fedha Kwanza', 'steps': ['Jua muda ulio nao: jumlisha akiba na malipo ya hatima, ugawanye kwa gharama za mwezi. Idadi, si hisia, ielekeze haraka yako.', 'Kata vishimo vikubwa: kodi, usajili, na kula nje. Bajeti moja ya kweli wiki hii inakununulia wiki za utulivu.'], 'note': None}, {'head': 'Jenga Hatua Inayofuata', 'steps': ['Je, utafute kazi kwa utaratibu: idadi maalum ya maombi kila siku inashinda kukimbilia mara moja kwa mwezi.', 'Sasisha uthibitisho mmoja: fanya upya CV yako leo. Kitendo chenyewe kinarejesha ujasiri.'], 'note': None}], 'questions': ['Ulipoteza kazi ghafla au kulikuwa na ishara?', 'Uko na muda gani wa fedha sasa?', 'Unataka mwelekeo gani wa kazi inayofuata?'], 'close': 'Niambie kuhusu muda wako na kazi unayotaka, nami nitakujengea mpango wa siku 30 wa kutafuta kazi.', 'followup': "Asante kwa kuniambia. Siku moja kwa wakati: leo fanya hesabu za fedha na sasisha kitu kimoja kwenye CV. Mwendo huo wa kimya unageuza 'nilipoteza kazi' kuwa 'sura mpya.'"}, 'fr': {'lead': "Perdre un travail attaque le revenu et l'identité en même temps - d'où la douleur. Le retour passe par stabiliser l'argent d'abord, puis retrouver une direction.", 'sections': [{'head': 'Encaissez sans paniquer', 'steps': ["Obtenez l'officiel: demandez par écrit la raison, le dernier jour, et les indemnités. L'information est un pouvoir.", 'Rien de dramatique pendant 24 heures: pas de messages furieux, pas de signatures importantes. Le premier jour sert à respirer.'], 'note': None}, {'head': "Protégez d'abord les finances", 'steps': ["Connaissez votre marge: épargne plus indemnités divisées par les coûts mensuels. Ce chiffre, pas les émotions, fixe l'urgence.", 'Coupez les grosses fuites: loyer, abonnements, restaurants. Une vraie séance de budget suffit.'], 'note': None}, {'head': 'Rebâtissez la suite', 'steps': ["Une recherche structurée: un quota d'envois par jour bat le marathon de panique.", "Actualisez une preuve de vous: rafraîchissez votre CV aujourd'hui. L'acte seul redonne confiance."], 'note': None}], 'questions': ['La perte était-elle soudaine ou annoncée ?', 'Quelle est votre marge financière réelle ?', 'Quelle direction pour le prochain poste ?'], 'close': 'Parlez-moi de votre marge et du rôle visé, et je construirai un plan de recherche de 30 jours.', 'followup': "Merci. Un jour à la fois : aujourd'hui, faites le calcul financier et mettez à jour une chose sur votre CV. Ce mouvement calme transforme 'j'ai perdu mon emploi' en 'mon prochain chapitre'."}}, 'rejection': {'keys': {'en': ['rejected', 'got rejected', 'she rejected me', 'he rejected me', 'she said no', 'he said no', 'turned me down', 'shot me down', "she isn't interested", "he isn't interested", 'not interested in me', 'friend-zoned', 'friendzoned', 'asked her out', 'asked him out', "said she's not interested", "said he's not interested", "didn't like me back", "doesn't like me back", 'brushed me off', 'blown off', 'kept my distance'], 'sw': ['amenikataa', 'amenikana', 'amenisema hapana', 'alisema hapana', 'alakataa', 'she said no', 'amenitelekeza', 'hakuwa ananipenda', 'simba'], 'fr': ['rejeté', 'rejetée', 'elle a dit non', 'il a dit non', "elle n'est pas intéressée", "il n'est pas intéressé", 'éconduit', 'éconduite', 'je me suis pris un râteau', 'se faire recaler', 'friendzone', "elle m'a repoussé", "il m'a repoussé"]}, 'topics': ['feelings_sad', 'feelings_lonely_topic'], 'en': {'lead': 'Rejection hurts so much because it feels like a verdict on your worth - but it is actually a verdict on one moment, with one person, in one set of circumstances. You are not the rejection.', 'sections': [{'head': 'Let the Sting Pass First', 'steps': ["Do not re-litigate it tonight: replaying the exact words and 'should haves' right after the hurt only deepens it. Sleep on it before you analyze it.", 'Name what actually hurts: is it the loss of hope, the embarrassment, or the feeling of being judged? Naming it shrinks it.'], 'note': "As relationship coaches keep pointing out: one person's 'no' is data about their life, timing and priorities - not a universal verdict on you."}, {'head': 'Recover Your Dignity', 'steps': ['One clean response, then move on: a short respectful reply (or silence) beats arguing or over-explaining. Your calmness becomes your reputation.', 'Rebuild the evidence file: list past wins, friends who chose you, and times people did want you around. Let facts outvote the inner critic.'], 'note': None}, {'head': 'Keep the Door Open for the World', 'steps': ['Return to the game in steps: go to that event, say yes to plans, meet new people. Volume heals - your odds get better the more you put yourself out there.', 'Improve what you control: fitness, grooming, conversation, and confidence are all trainable. Every small upgrade raises your next odds.'], 'note': None}], 'questions': ['Was this a first attempt or after real connection?', 'What stings more - the no itself, or the hope you had built?', 'Is there anything about yourself you actually want to improve, apart from the rejection?'], 'close': "Tell me a little about the person and the moment, and I'll help you understand it without the humiliation spiral.", 'followup': "That gives me the picture. Take tonight to just feel it without analyzing it. Tomorrow, do one thing that reminds you people like you - a message to a friend, a workout, a plan with people - because that is the fastest antidote to one person's 'no'."}, 'sw': {'lead': 'Kukataliwa kaumiza sana kwa sababu kinahisi kama hukumu juu ya thamani yako - lakini ni hukumu juu ya wakati mmoja, mtu mmoja, na hali moja. Wewe si kukataliwa.', 'sections': [{'head': 'Acha Uchungu Upite Kwanza', 'steps': ['Usichunguze tena usiku huu: kurudiarudia maneno makubwa kunazidisha tu maumivu. Lala, halafu uchambue.', 'Taja kinachouma kweli: kupotea kwa tumaini, aibu, au hisia ya kuhukumiwa? Kukitaja kunakipunguza.'], 'note': None}, {'head': 'Rejesha Heshima Yako', 'steps': ['Jibu moja safi, halafu endelea: jibu fupi la heshima (au ukimya) linashinda kubishana.', 'Jenga orodha ya uthibitisho: ushindi wa zamani, marafiki waliokuchagua, na nyakati watu walikutaka.'], 'note': None}, {'head': 'Endelea Kukutana na Watu', 'steps': ['Rudi hatua kwa hatua: nenda shughulini, kubali mipango, kutana na watu wapya. Nafasi zako zinaboreka kadri unavyojitokeza.', 'Boresha unachoweza kudhibiti: siha, mwonekano, mazungumzo, na ujasiri - yote yanaweza kufunzwa.'], 'note': None}], 'questions': ['Hii ni jaribio la kwanza au baada ya uhusiano halisi?', 'Ni nini kinasikitisha zaidi - kukataliwa au tumaini ulilokuwa?', 'Kuna kitu unachotaka kuboresha kwako, nje ya suala hili?'], 'close': 'Niambie kidogo kuhusu mtu na wakati huo, nami nitakusaidia kuelewa bila mzunguko wa kujidharau.', 'followup': 'Hilo linanipa picha. Usiku huu, hisi tu bila kuchambua. Kesho fanya jambo moja linalokumbusha watu wanakupenda - ujumbe kwa rafiki, mazoezi, au mpango na watu.'}, 'fr': {'lead': "Le rejet fait mal parce qu'on le vit comme un verdict sur notre valeur - mais c'est un verdict sur un moment, une personne, un contexte. Vous n'êtes pas le rejet.", 'sections': [{'head': 'Laissez passer la piqûre', 'steps': ["Ne ressassez pas ce soir: rejouer les mots et les 'j'aurais dû' aggrave la blessure. Dormez avant d'analyser.", "Nommez ce qui blesse: la perte d'espoir, la gêne, ou le sentiment d'être jugé ? Le nommer le réduit."], 'note': None}, {'head': 'Retrouvez votre dignité', 'steps': ["Une réponse propre, puis avancez: un mot respectueux ou le silence bat l'argumentation.", "Reconstruisez le dossier des preuves: vos victoires, vos amis, les fois où l'on vous a choisi."], 'note': None}, {'head': 'Gardez la porte ouverte', 'steps': ['Reprenez par étapes: sortez, acceptez des plans, rencontrez du monde. Le volume cicatrise.', "Améliorez ce qui dépend de vous: forme, conversation, confiance - tout s'entraîne."], 'note': None}], 'questions': ['Première tentative ou après un vrai lien ?', "Qu'est-ce qui pique le plus - le non ou l'espoir construit ?", 'Y a-t-il quelque chose de vous à améliorer, indépendamment du rejet ?'], 'close': "Racontez-moi la personne et le moment, et je vous aiderai à comprendre sans la spirale d'humiliation.", 'followup': "Voilà l'image. Ce soir, ressentez sans analyser. Demain, une chose qui vous rappelle que les gens vous aiment - un message, un entraînement, un plan - c'est l'antidote le plus rapide à un 'non'."}}, 'betrayal': {'keys': {'en': ['betrayed', 'betrayal', 'stabbed in the back', 'cheated on me', 'she cheated', 'he cheated', 'lied to me', 'she lied to me', 'he lied to me', 'broke my trust', 'backstabbed', 'my friend betrayed me', 'turned on me', 'deceived me', 'she broke her promise', 'he broke his promise', 'exposed my secrets', 'kept things from me', 'my buddy stabbed me', 'double crossed', 'double-crossed'], 'sw': ['amenisaliti', 'saliti', 'amemparadisia', 'amemwambia wengine', 'ukanovu', 'amemwangamiza', 'rafiki ameniteuka', 'amenidanganya', 'amenikwaa', 'alikwenda nyuma yangu', 'aliifichua siri yangu'], 'fr': ['trahi', 'trahie', 'trahison', 'poignardé dans le dos', 'poignardée dans le dos', 'trompé', 'trompée', 'menti', 'a rompu ma confiance', 'trahi par mon ami', 'trahie par mon ami', 'doublé', 'doublée', 'retourné contre moi', "m'a laissé tomber"]}, 'topics': ['feelings_angry_topic', 'feelings_sad'], 'en': {'lead': 'Being betrayed by someone you trusted is a double wound - you lose the relationship and you question your own judgment. Both are painful, but both heal with boundaries, not with revenge.', 'sections': [{'head': 'Let the Loss Be Real', 'steps': ['Name the specific betrayal: was the trust broken by secrecy, a lie, gossip, a hookup, or a kept promise? Naming the exact break stops the blur.', "Grieve the person you thought they were: part of this pain is mourning the version of them that didn't exist. That grief is legitimate."], 'note': 'Trust and respect, as every counselor will tell you, are rebuilt only by changed behavior over time - apologies alone mean close to nothing.'}, {'head': 'Do Not Decide in the Flame', 'steps': ['Delay the big confrontation: anger is loud and short; decisions made in it are usually regretted. Give yourself 48 hours before acting on impulse.', 'Collect facts, not rumors: what did they actually do versus what you assumed? Your case should be built on what you can verify.'], 'note': None}, {'head': 'Rebuild or Walk - by Design', 'steps': ['If you stay or rebuild: it requires a real apology, a changed behavior, and a set of new boundaries - otherwise history repeats.', "If you leave: leave cleanly and entirely. A press of the 'delete' on the relationship, done once, heals faster than years of half-resentment."], 'note': None}], 'questions': ['What exactly did they do that broke your trust - the specific act?', 'Is there any chance the picture is incomplete, or is it verified?', 'Deep down, do you want to rebuild this or end it?'], 'close': "Tell me the exact break and what you actually want, and I'll help you plan the cleanest response.", 'followup': 'That clarifies it. Whatever you choose, keep the decision out of your angriest hour: write what happened, what you want, and what you will not accept - then act once, cleanly. Whichever door you pick, your self-respect is the thing that stays with you.'}, 'sw': {'lead': 'Kusalitiwa na mtu uliyemwamini ni jeraha maradufu - unapoteza uhusiano na unahoji uamuzi wako mwenyewe. Yote yanapona kwa mipaka, si kwa kulipiza.', 'sections': [{'head': 'Tambua Hasara kwa Ukweli', 'steps': ['Taja usaliti hasa: siri? uwongo? porojo? mwendo? Kutaja hasa kunakomesha mteleto.', 'Omboleza mtu uliyemfikiria: sehemu ya maumivu ni kuuondolea maziko toleo la mtu asiyekuwapo.'], 'note': None}, {'head': 'Usiamue Kwenye Moto', 'steps': ['Ahirisha makabiliano makubwa: hasira ni kubwa na fupi; maamuzi yake huletwa majuto. Jipe saa 48.', 'Kusanya ukweli, si uvumi: walifanya nini hasa? Jenga kesi kwa unachoweza kuthibitisha.'], 'note': None}, {'head': 'Jenga Upya Au Ondoka - Kwa Mpangilio', 'steps': ['Ukibaki: ombi la kweli, tabia iliyobadilika, na mipaka mipya - la sivyo historia inajirudia.', 'Ukiondoka: ondoka kwa urahisi kabisa. Kufunga uhusiano mara moja kunaponya haraka kuliko chuki ya miaka.'], 'note': None}], 'questions': ['Walifanya nini hasa kilichovunja imani yako?', 'Je, picha ni kamili, au kuna uwezekano wa kukosekana?', 'Moyoni, unataka kujenga upya au kumaliza?'], 'close': 'Niambie uwazi uliovunjika na unachotaka hasa, nami nitakusaidia kupanga jibu safi zaidi.', 'followup': 'Hilo linafafanua. Chochote unachochagua, usiipe uamuzi saa ya hasira kubwa: andika kilichotokea, unachotaka, na usichokubali - halafu tenda mara moja kwa urahisi.'}, 'fr': {'lead': "Être trahi par quelqu'un de confiance est une double blessure : vous perdez la relation et doutez de votre jugement. Les deux guérissent par des limites, pas par la vengeance.", 'sections': [{'head': 'Rendez la perte réelle', 'steps': ['Nommez la trahison précise: secret, mensonge, rumeur, infidélité ? Nommer la rupture exacte arrête le brouillard.', "Faites le deuil de la personne imaginée: une partie de la peine, c'est perdre une version qui n'existait pas."], 'note': None}, {'head': 'Ne décidez pas à chaud', 'steps': ['Repoussez la grande confrontation: la colère est courte et regrette vite. Donnez-vous 48 heures.', "Collectez des faits, pas des rumeurs: qu'ont-ils vraiment fait ? Basez votre cas sur le vérifiable."], 'note': None}, {'head': 'Reconstruire ou partir - avec méthode', 'steps': ["Si vous restez: excuses réelles, comportement changé, nouvelles limites - sinon l'histoire se répète.", "Si vous partez: partez proprement. Fermer la relation d'un coup guérit plus vite que des années de ressentiment."], 'note': None}], 'questions': ["Qu'est-ce qu'ils ont fait exactement ?", "L'image est-elle complète ou incomplète ?", 'Au fond, reconstruire ou terminer ?'], 'close': 'Racontez la rupture exacte et ce que vous voulez, et je planifierai la réponse la plus propre.', 'followup': "C'est plus clair. Quel que soit votre choix, tenez la décision hors de l'heure de colère : écrivez les faits, vos besoins, vos limites - puis agissez une fois, proprement."}}, 'family_conflict': {'keys': {'en': ['my parents', 'fighting with my parents', 'arguing with my parents', 'fighting with my mom', 'fighting with my dad', 'arguing with my mom', 'arguing with my dad', 'my mom is mad', 'my dad is mad', 'my mother thinks', 'my father thinks', 'fights at home', 'family is toxic', "my family doesn't understand me", "my parents don't understand me", "my mom doesn't understand", "my dad doesn't understand", 'strict parents', 'overbearing parents', 'my family is against me', "they're always on my back", 'kicked out of the house', 'disowned'], 'sw': ['wazazi wangu', 'mama yangu', 'baba yangu', 'mama ananifurukuta', 'baba ananifurukuta', 'mabishano nyumbani', 'familia yangu haielewi', 'wazazi wangu hawaelewi', 'wazazi wakali', 'familia yangu inanipinga', 'nimefukuzwa nyumbani', 'kukosana na wazazi', 'ndugu wangu', 'dada yangu'], 'fr': ['mes parents', 'ma mère', 'mon père', 'dispute avec mes parents', 'dispute avec ma mère', 'dispute avec mon père', 'ma mère est en colère', 'mon père est en colère', 'ma famille ne me comprend pas', 'mes parents ne me comprennent pas', 'parents stricts', 'contre moi', 'renvoyé de la maison', 'renvoyée de la maison', 'brouillé avec ma famille', 'brouillée avec ma famille']}, 'topics': ['feelings_angry_topic', 'stress_overwhelm_topic'], 'en': {'lead': 'Family conflict is the hardest because you cannot easily walk away, and the people who hurt you are the same ones who raised you. But you can still set adult boundaries and keep your peace.', 'sections': [{'head': 'Sort the Battle From the Pattern', 'steps': ['Ask what the fight is really about: is it this one issue, or years of unmet expectations? Knowing the pattern stops you from fighting the wrong war.', 'Decide what is yours: what in this clash is actually your responsibility, and what is their reaction to you? Own yours; name theirs; do not absorb it.'], 'note': 'Family therapists stress this: you cannot change their behavior, but you can change your side of the conversation - and that alone changes the dynamic.'}, {'head': 'Speak in a Way They Can Hear', 'steps': ["Use the formula: 'When you (fact), I feel (feeling), and I need (request).' Blame makes family double down; requests leave room.", 'Choose the timing: talk when everyone is calm and in private. Ten calm minutes beat an hour of kitchen-table shouting.'], 'note': None}, {'head': 'Set Boundaries With Respect', 'steps': ["Define the line clearly: 'I will not discuss X', 'I will leave the room if Y happens', 'I will call once a week'. State it once, calmly, repeated as needed.", 'Accept what you cannot control: if they will not change, you can still control your distance, your calm, and your own choices - including moving out or limiting contact.'], 'note': None}], 'questions': ['Is this one specific battle, or is it the same fight happening again and again?', "What would a 'good enough' outcome look like - perfect harmony, or just less pain?", 'Can you control your space and time, or are you fully dependent right now?'], 'close': "Tell me the exact conflict pattern and how much freedom you have, and I'll help you script the next conversation.", 'followup': 'That tells me the shape of it. The adult move is not to win the fight but to change the few variables you do control: your tone, your boundaries, and your exit. Practice the formula sentence once this week - on the smallest topic - so it is ready for the big one.'}, 'sw': {'lead': 'Migogoro ya familia ni migumu zaidi kwa sababu huwezi kuondoka kwa urahisi, na wakuumizao ni wale wale waliokulea. Lakini bado unaweza kuweka mipaka na kudumisha amani yako.', 'sections': [{'head': 'Tambua Vita Na Mfumo', 'steps': ['Uliza mgogoro unahusu nini hasa: suala hili moja, au miaka ya matarajio? Kujua mfumo kunakusaidia usipigane vita vibaya.', 'Amua nini chako: ni nini wajibu wako katika hili, na ni nini mmenyuko wao kwako? Chukua chako, taja chao, usikisike chini.'], 'note': None}, {'head': 'Sema kwa Njia Watakayoisikia', 'steps': ["Tumia formula: 'Unapofanya (ukweli), nahisi (hisia), na ninahitaji (ombi).' Kulaumu kunazidisha; maombi yanaacha nafasi.", 'Chagua wakati: zungumza wakati wote wametulia kwa faragha. Dakika kumi za utulivu zinashinda saa ya kelele.'], 'note': None}, {'head': 'Weka Mipaka Kwa Heshima', 'steps': ["Elezaw e mstari wazi: 'Sitajadili X', 'Nitondoka kama Y itatokea', 'Nitapiga simu mara moja kwa wiki'. Semeni mara moja kwa utulivu.", 'Kubali usichoweza kudhibiti: ikiwa hawatabadilika, wewe bado unadhibiti umbali wako, utulivu wako, na maamuzi yako.'], 'note': None}], 'questions': ['Hii ni vita moja maalum au mgogoro sawa unajirudia?', "Matokeo 'ya kutosha' yangekuwaje - maelewano kamili au maumivu machache tu?", 'Unaweza kudhibiti nafasi na muda wako, au unategemea kabisa sasa?'], 'close': 'Niambie muundo hasa wa mgogoro na kiwango chako cha uhuru, nami nitakusaidia kuandika mazungumzo yanayofuata.', 'followup': 'Hiyo inanipa sura. Hatua ya watu wazima sio kushinda vita bali kubadilisha vigezo vichache unavyoweza kudhibiti: toni, mipaka, na njia yako ya kuondoka. Fanya mazoezi ya sentensi formula wiki hii kwa mada ndogo ndogo.'}, 'fr': {'lead': "Le conflit familial est le plus dur car on ne peut pas partir facilement, et ceux qui blessent sont ceux qui ont élevé. Mais vous pouvez poser des limites d'adulte et garder la paix.", 'sections': [{'head': 'Démêlez la bataille du schéma', 'steps': ["Demandez le vrai sujet: cet incident, ou des années d'attentes ? Connaître le schéma évite de se battre pour rien.", 'Décidez de votre part: quelle est votre responsabilité, et quelle est leur réaction ? Prenez la vôtre, nommez la leur.'], 'note': None}, {'head': "Parlez d'une façon audible", 'steps': ["Utilisez la formule: 'Quand tu (fait), je ressens (émotion), et j'ai besoin de (demande).'", "Choisissez le moment: calme et en privé. Dix minutes tranquilles valent mieux qu'une heure de cris."], 'note': None}, {'head': 'Fixez des limites avec respect', 'steps': ["Définissez la ligne: 'Je ne discuterai pas X', 'Je quitterai la pièce si Y'. Dites-la une fois, calmement.", "Acceptez l'incontrôlable: s'ils ne changent pas, vous contrôlez votre distance, votre calme et vos choix."], 'note': None}], 'questions': ['Une bataille isolée ou un schéma répété ?', "À quoi ressemblerait un résultat 'assez bien' ?", 'Contrôlez-vous votre espace et votre temps ?'], 'close': 'Décrivez le schéma exact et votre liberté, et je vous aiderai à écrire la prochaine conversation.', 'followup': "Voilà la forme. Le geste adulte n'est pas de gagner la dispute mais de changer vos variables : le ton, les limites, la sortie. Essayez la phrase-formule cette semaine, sur le sujet le plus petit."}}, 'money_stress': {'keys': {'en': ['money stress', 'no money', "i'm broke", 'i am broke', "i'm out of money", "can't pay my bills", "can't pay rent", 'behind on bills', 'in debt', 'deep in debt', 'my debts', 'struggling financially', 'financially stressed', "can't afford", 'short on cash', 'broke and stressed', 'rent is due', 'bills piling up', 'money worries', 'living paycheck to paycheck', 'overdrawn', "can't make ends meet"], 'sw': ['msongo wa pesa', 'sina pesa', 'nimeishiwa pesa', 'siwezi kulipa bili', 'siwezi kulipa kodi', 'madeni', 'mimi ni fukara', 'nikokota deni', 'shida ya kifedha', 'nimezidiwa na gharama', 'pesa hazitoshi'], 'fr': ["problèmes d'argent", 'je suis fauché', 'je suis fauchée', 'sans argent', "je n'arrive pas à payer", 'peux pas payer le loyer', 'dettes', 'endetté', 'endettée', 'difficultés financières', 'stress financier', "je n'y arrive plus", 'juste à la fin du mois', 'à découvert']}, 'topics': ['stress_overwhelm_topic', 'anxiety_topic'], 'en': {'lead': 'Money stress is never really about the number - it is about the fear of losing control. The fix is not magic income; it is turning chaos into a visible, numbered plan.', 'sections': [{'head': 'Face the Real Number', 'steps': ['Write every bill, debt and income in one place: the honest total is usually scary for an hour, then liberating - because now it is a math problem, not a fog.', 'Separate fixed from flexible: rent and loans are fixed; food, data and fun can bend. The flexible column is where your first relief lives.'], 'note': 'Every money coach gives the same starter advice: a budget is not a restriction, it is spending on purpose - and purpose ends panic.'}, {'head': 'Make the Immediate Shake', 'steps': ['The 30-day patch: contact your providers and ask for a payment plan or extension - most would rather restructure than chase you.', 'Cut or pause the leaks: pause subscriptions, prepay data only, cook at home. Small, visible wins rebuild control fast.'], 'note': None}, {'head': 'Build a Forward Plan', 'steps': ['Attack the highest-interest debt first while making minimums everywhere: it saves the most money per effort.', 'Add one income lever: extra hours, a side skill, selling unused items. Even a small second stream changes the fear level.'], 'note': None}], 'questions': ['What does the honest monthly picture look like - income versus all outgoings?', 'Which bill or debt weighs on you the most right now?', 'Do you have anyone who could help you think this through, or is it all on you?'], 'close': "Tell me the rough income and outgoing numbers, and I'll help you make a simple first-week plan.", 'followup': "That's the starting point, and starting is the hard part. This week do only three things: list every number, call ONE provider about a plan, and pause ONE subscription. Visible control beats earned more, faster - the money follows the calm."}, 'sw': {'lead': 'Msongo wa pesa kamwe hauhusu namba kwanza - unahusu woga wa kupoteza udhibiti. Suluhisho si mapato ya miujiza; ni kugeuza machafuko kuwa mpango wa namba unaoonekana.', 'sections': [{'head': 'Kabiliana na Namba Halisi', 'steps': ['Andika kila bili, deni na mapato mahali pamoja: jumla halisi hofusha kwa saa moja, halafu inaachilia - kwa sababu sasa ni tatizo la hesabu.', 'Tenganisha fasta na inayoweza kubadilika: kodi na mikopo ni fasta; chakula, data na burudani zinabadilika.'], 'note': None}, {'head': 'Fanya Marekebisho ya Siku 30', 'steps': ['Waalike watoa huduma: uliza mpango wa malipo au uhabishaji - wengi wanapendelea kuandaa kuliko kukukimbiza.', 'Kata au sitisha uvujaji: sitisha usajili, chagua data tu, pika nyumbani.'], 'note': None}, {'head': 'Jenga Mpango wa Mbele', 'steps': ['Shambulia deni la riba kubwa kwanza ukilipa mapema mengine: linaokoa pesa nyingi kwa juhudi.', 'Ongeza mkondo mmoja wa mapato: saa za ziada, ujuzi mdogo, kuuza vitu visivyotumika.'], 'note': None}], 'questions': ['Picha halisi ya mwezi ikoje - mapato dhidi ya gharama zote?', 'Ni bili gani inakulemea zaidi sasa?', 'Kuna mtu anayeweza kukusaidia kufikiri, au yote kwako?'], 'close': 'Niambie makisio ya mapato na matumizi, nami nitakusaidia mpango rahisi wa wiki ya kwanza.', 'followup': 'Hiyo ndio mwanzo, na kuanza ndio sehemu ngumu. Wiki hii fanya mambo matatu tu: andika kila namba, piga simu kwa mtoa huduma mmoja, na usitishe usajili mmoja.'}, 'fr': {'lead': "Le stress d'argent ne parle jamais vraiment du chiffre - il parle de la peur de perdre le contrôle. La solution n'est pas un revenu magique, mais un plan chiffré et visible.", 'sections': [{'head': 'Regardez le vrai chiffre', 'steps': ["Notez chaque facture, dette et revenu au même endroit: le total honnête fait peur une heure, puis libère - c'est un problème de maths.", 'Séparez fixe et flexible: loyer et crédits sont fixes; nourriture, forfait et loisirs plient.'], 'note': None}, {'head': 'Faites le correctif de 30 jours', 'steps': ['Contactez les fournisseurs: demandez un échéancier - la plupart préfèrent réaménager plutôt que courir après vous.', 'Coupez ou mettez en pause: abonnements, adressez-vous, cuisinez à la maison.'], 'note': None}, {'head': "Construisez un plan d'avance", 'steps': ['Attaquez la dette la plus chère en payant le minimum partout ailleurs.', "Ajoutez un levier de revenu: heures en plus, compétence, vente d'objets inutilisés."], 'note': None}], 'questions': ['Comment est le vrai bilan mensuel - revenus contre dépenses ?', 'Quelle facture pèse le plus ?', "Quelqu'un peut-il vous aider à y réfléchir ?"], 'close': "Donnez-moi l'image approximative, et je ferai un plan simple de première semaine.", 'followup': "C'est le point de départ, et commencer est le plus dur. Cette semaine, trois choses seulement : listez chaque chiffre, appelez un fournisseur, coupez un abonnement."}}, 'fear_phobia': {'keys': {'en': ['afraid of', 'scared of', 'terrified of', 'phobia', 'frightened of', 'afraid to try', 'afraid to fail', 'scared to fail', 'afraid to speak', 'scared of speaking', 'afraid of heights', 'scared of heights', 'scared of spiders', 'afraid of the dark', 'scared of the dark', 'scared of dogs', 'afraid of dogs', 'scared of flying', 'afraid of flying', 'scared of crowds', 'afraid of crowds', 'fear of failure', 'fear of rejection', 'fear of speaking', "i'm so scared", 'i am so scared', 'terrified', 'petrified'], 'sw': ['naogopa', 'na hofu', 'hofu ya', 'woga wa', 'nina woga', 'naogopa kufeli', 'naogopa kusema', 'naogopa giza', 'naogopa kuinuka', 'naogopa mbwa', 'naogopa kuruka', 'silogopi', 'ninatetemeka'], 'fr': ['peur de', "j'ai peur de", "peur de l'échec", 'peur du noir', 'peur des hauteurs', 'peur des chiens', 'peur de parler', "peur de l'avion", 'phobie', 'terrifié', 'terrifiée', 'tremble de peur', 'je flippe', 'anxiété de performance']}, 'topics': ['fear_phobia_topic', 'feelings_nervous_topic'], 'en': {'lead': 'Fear is a fire alarm that is sometimes right and sometimes just old wiring. The skill is not to make fear disappear - it is to stop letting it drive the decisions alone.', 'sections': [{'head': 'Sort the Alarm Levels', 'steps': ['Rate the fear from 1 to 10 for the actual risk, then for the fear itself: most fears rank the risk low and the fear high - and that gap is the real problem.', "Ask the alarm's question: 'What exactly do I believe will happen?' Writing it makes the vague threat small enough to examine."], 'note': 'As exposure therapists repeat: fear reduces with repeated, graded contact with the thing - in tiny steps designed for you, at your pace.'}, {'head': 'Step Toward It in Tiny Pieces', 'steps': ["Build a ladder: if 'giving a presentation' is a 10, find a 2 (say hi to strangers), a 4 (speak in a small group), and a 6 (short presentation to friends). Walk one rung a week.", 'Stay until it drops: each rung, wait until the fear falls at least three points before stopping - leaving at the peak teaches your brain to expect peaks.'], 'note': None}, {'head': 'Arm the Body, Not Just the Mind', 'steps': ["Use the pause: slow border exhales (in 4, out 6) and name three objects you can see before you act. It short-circuits the alarm's volume.", "Reframe the symptom as fuel: jitters, fast heart, and butterflies are adrenaline - the same chemical champions use. Name it 'excited', and you can use it."], 'note': None}], 'questions': ['What exactly is the feared situation, stated in one concrete scene?', 'When you look honestly, what is the actual risk versus the felt risk?', 'What is the smallest version of the thing you could try this week?'], 'close': "Describe your ladder's bottom rung, and I'll help you design the first tiny, safe step this week.", 'followup': 'Good - that rung is small enough. This week, only do that one rung, and only stop after you feel the fear drop a little. One rung at a time, at your pace, and the ladder stops looking like a cliff.'}, 'sw': {'lead': 'Hofu ni kengele ya moto ambayo wakati mwingine ni sahihi na wakati mwingine ni wiring ya zamani. Ustadi si kutoweka kwa hofu - ni kuiacha isiendeshe maamuzi peke yake.', 'sections': [{'head': 'Pambanua Viwango vya Kengele', 'steps': ['Kadiria hofu 1-10 kwa hatari halisi, halafu kwa hofu yenyewe: hofu nyingi zina hatari ndogo lakini hisia kubwa - na pengo hilo ndilo tatizo.', "Uliza swali la kengele: 'Ninaamini nini hasa kitatokea?' Kuandika kunafanya tishio liwe dogo."], 'note': None}, {'head': 'Endelea Kuelekea Kwa Vipande Vidogo', 'steps': ["Jenga ngazi: ikiwa 'kutoa wasilisho' ni 10, pata 2 (salamia wageni), 4 (zungumza kikundi kidogo), 6 (wasilisho fupi kwa marafiki). Tembea ngazi moja kwa wiki.", 'Kaa mpaka ianguke: kila ngazi, subiri hofu ishuke angalau pointi tatu kabla ya kuacha.'], 'note': None}, {'head': 'Jenga Mwili, Si Akili Tu', 'steps': ['Tumia pause: pumua polepole (4, toa 6) na taja vitu vitatu unavyoona kabla ya kutenda.', 'Badilisha dalili kuwa nishati: utetemeko na moyo wa mbio ni adrenalini - kemikali wanayotumia mabingwa.'], 'note': None}], 'questions': ['Hali unayoiogopa ni ipi hasa?', 'Kwa uaminifu, hatari halisi dhidi ya hisia ni ipi?', 'Toleo dogo zaidi unaloweza kujaribu wiki hii ni nini?'], 'close': 'Elezaw ngazi ya chini kabisa, nami nitakusaidia kubuni hatua ndogo salama ya wiki hii.', 'followup': 'Vizuri - ngazi hiyo ni ndogo vya kutosha. Wiki hii fanya ngazi moja tu, na usiache hadi hisi hofu ikipungua kidogo. Ngazi moja kwa wakati, kwa mwendo wako.'}, 'fr': {'lead': "La peur est une alarme parfois juste, parfois de vieux câblage. La compétence n'est pas de la faire disparaître - c'est d'arrêter de la laisser décider seule.", 'sections': [{'head': "Faites le tri des niveaux d'alarme", 'steps': ['Notez la peur de 1 à 10 pour le risque réel, puis pour la peur elle-même: beaucoup de peurs ont un risque faible et une sensation forte.', "Posez la question de l'alarme: 'Qu'est-ce que je crois qu'il va se passer ?' L'écrire rétrécit la menace."], 'note': None}, {'head': 'Approchez par petits morceaux', 'steps': ["Construisez une échelle: si 'faire un exposé' vaut 10, trouvez un 2 (saluer), un 4 (petit groupe), un 6 (amis). Un barreau par semaine.", "Restez jusqu'à la descente: chaque barreau, attendez que la peur baisse d'au moins trois points."], 'note': None}, {'head': "Armez le corps, pas seulement l'esprit", 'steps': ['Utilisez la pause: expirations lentes (4-6) et nommez trois objets visibles.', "Reformulez le symptôme en carburant: tremblements et cœur rapide sont de l'adrénaline - dites 'excité', et utilisez-la."], 'note': None}], 'questions': ['Quelle est la situation exacte que vous craignez ?', 'Risque réel contre risque ressenti ?', 'Quelle est la plus petite version à tenter cette semaine ?'], 'close': 'Décrivez le premier barreau de votre échelle, et je concevrai le tout petit pas sûr de cette semaine.', 'followup': "Bien - ce barreau est assez petit. Cette semaine, faites uniquement ce barreau, et ne vous arrêtez qu'une fois la peur un peu redescendue. Un barreau à la fois, et l'échelle cesse d'être une falaise."}}, 'overthinking': {'keys': {'en': ['overthinking', 'overthink', "can't stop thinking", "can't stop overthinking", 'i keep thinking about', "i can't switch off my brain", "my mind won't stop", 'racing mind', 'i think about it all day', 'i replay everything', 'i go over it again', 'what if scenarios', "my head won't rest", 'analysis paralysis'], 'sw': ['kufikiri kupita kiasi', 'siwezi kuacha kufikiri', 'mawazo yananijia kila mara', 'ubongo wangu haunyamazi', 'najirudia kila kitu', 'mawazo yanakimbia', 'ninajitenga', 'sina usingizi kwa mawazo'], 'fr': ['je pense trop', 'je ressasse', "je n'arrête pas d'y penser", "mon cerveau ne s'arrête pas", 'je repasse tout en boucle', 'pensées en cascade', 'paralysie par analyse', 'je tourne en boucle']}, 'topics': ['rumination_topic', 'anxiety_topic', 'feelings_nervous_topic'], 'en': {'lead': 'Overthinking is your brain trying to solve a problem by repeating it louder, as if volume were understanding. It is a habit, not a truth-teller - and habits can be retrained.', 'sections': [{'head': 'Catch the Loop Early', 'steps': ["Name it out loud: say 'this is a loop, again' - a label breaks the trance more than you would think.", "Move the thought to paper: write the worry once, fully, with a 'next step' line under it. Paper ends the endless re-run."], 'note': "Therapists call it 'thought parking': you can put a thought on hold, not because it is solved, but because writing it down tells the brain it was witnessed."}, {'head': 'Run the Two Questions', 'steps': ["Ask 'Can I act on this right now?' If yes, do the smallest action. If no, it belongs to a scheduled worry time, not this minute.", "Ask 'What is the price of this loop?' Three loops a day cost real focus and peace - noticing the cost re-motivates you to park it."], 'note': None}, {'head': 'Starve the Engine', 'steps': ['Set a worry window: 10 minutes, once a day, for writing worries - everything outside it gets parked until then.', 'Fill the gaps on purpose: overthinking loves empty time. Plan the next hour in small steps so there is no void to fill with loops.'], 'note': None}], 'questions': ['What is the topic it keeps circling - one thing, or many?', 'Is there action you could take today, or is it genuinely out of your hands?', 'When does the loop hit hardest - night, work, or quiet moments?'], 'close': "Tell me one loop that is loudest right now, and I'll show you how to park it today.", 'followup': 'This one, at least, we can handle today. The loop is loud because it is idle. Take the thought, write it once with one next step, then do that step - even if tiny - and give the worry its 10-minute slot later. Practice that, and the loop loses its grip.'}, 'sw': {'lead': 'Kufikiri kupita kiasi ni ubongo ukijaribu kutatua tatizo kwa kulisema kwa nguvu zaidi, kana kwamba sauti ni uelewa. Ni mazoea, si msemaji wa ukweli - na mazoea yanaweza kutumwa mabadiliko.', 'sections': [{'head': 'Kamata Loop Mwanzoni', 'steps': ["Litaje kwa sauti: sema 'hii ni loop, tena' - lebo inavunja ujazo zaidi kuliko unavyofikiria.", "Hamisha wazo kwenye karatasi: andika wasiwasi mara moja, kamili, na mstari wa 'hatua inayofuata'."], 'note': None}, {'head': 'Endesha Maswali Mawili', 'steps': ["Uliza 'Naweza kulitenda sasa?' Kama ndio, fanya hatua ndogo. La sivyo, ni la wakati wa wasiwasi uliopangwa.", "Uliza 'Bei ya loop hii ni nini?' - mara tatu kwa siku zinagharimu umakini na amani."], 'note': None}, {'head': 'Funga Nishati ya Injini', 'steps': ['Weka dirisha la wasiwasi: dakika 10 mara moja kwa siku za kuandika.', 'Jaza mapengo kwa makusudi: overthinking inapenda muda usio na kazi. Panga saa inayofuata hatua ndogo.'], 'note': None}], 'questions': ['Ni mada gani inayojirudia?', 'Kuna hatua ya leo, au iko nje ya mikono yako?', 'Loop inakusumbua lini zaidi - usiku, kazini, au nyakati za kimya?'], 'close': 'Niambie loop moja iliyo kubwa sasa, nami nitakuonyesha jinsi ya kuipaka leo.', 'followup': 'Hii moja angalau tunaweza kuishughulikia leo. Loop inapaza sauti kwa sababu iko idle. Chukua wazo, liandike mara moja na hatua moja, kisha fanya hatua hiyo - hata ndogo - na upe wasiwasi nafasi yake dakika 10 baadaye.'}, 'fr': {'lead': "Trop penser, c'est votre cerveau qui essaie de résoudre un problème en le répétant plus fort, comme si le volume était la compréhension. C'est une habitude, pas une vérité - et les habitudes se rééduquent.", 'sections': [{'head': 'Attrapez la boucle tôt', 'steps': ["Nommez-la à voix haute: 'c'est une boucle, encore' - le label casse la transe.", "Mettez la pensée sur papier: écrivez l'inquiétude une fois, avec une ligne 'prochaine étape'."], 'note': None}, {'head': 'Posez les deux questions', 'steps': ["'Puis-je agir maintenant ?' Si oui, faites la plus petite action. Sinon, c'est pour l'heure des soucis programmée.", "'Quel est le coût de cette boucle ?' Le remarquer remotive à la garer."], 'note': None}, {'head': 'Affamez le moteur', 'steps': ["Fixez une fenêtre d'inquiétude: 10 minutes par jour pour écrire.", "Remplissez les vides à dessein: la sur-pensée aime le temps vide. Planifiez l'heure suivante."], 'note': None}], 'questions': ['Sur quel sujet la boucle tourne-t-elle ?', "Y a-t-il une action possible aujourd'hui ?", 'Quand frappe-t-elle le plus fort ?'], 'close': "Décrivez une boucle bien présente, et je vous montrerai comment la garer aujourd'hui.", 'followup': "Celle-ci, au moins, on peut la traiter aujourd'hui. La boucle crie parce qu'elle est oisive. Écrivez la pensée une fois, ajoutez une prochaine étape, faites-la - même minuscule - et donnez-lui son créneau de 10 minutes plus tard."}}, 'self_doubt': {'keys': {'en': ["i'm not good enough", "i'm not smart enough", 'not good enough', "i can't do it", "i can't do this", "i'm a failure", 'i always mess up', 'i doubt myself', "i don't believe in myself", "i'm useless", "i'm not capable", 'impostor', 'imposter syndrome', 'everyone else is better', "i'm way behind everyone", "i don't deserve this", "i'm not ready", "i'm afraid i'll mess up", 'i keep failing', "i'm nothing", "i'm a loser"], 'sw': ['sitoshelezi', 'sina akili ya kutosha', 'siwezi', 'mimi ni mjinga', 'nashindwa', 'najishuku', 'sijiamini', 'sina maana', 'wengine bora kuliko mimi', 'niko nyuma sana', 'sistahili hili', 'siko tayari', 'sina kipaji'], 'fr': ['pas assez bon', 'pas assez intelligente', "je n'y arriverai jamais", 'je suis nul', 'nulle', 'je doute de moi', 'je ne crois pas en moi', 'bon à rien', 'imposteur', 'imposture', 'les autres sont meilleurs', 'je suis en retard', 'je ne le mérite pas', 'je ne suis pas prêt', 'je vais tout rater', 'je rate tout']}, 'topics': ['mental_health_checkin_topic', 'feeling_stuck_topic'], 'en': {'lead': 'Self-doubt is the inner critic speaking at full volume - but it is one voice, not the whole crowd. The counter is not blind confidence; it is evidence, progress and small proof.', 'sections': [{'head': 'Separate the Critic From the Facts', 'steps': ['Write the criticism as a sentence, then check it line by line: has it always been true, or is it specific and temporary? Facts crack the generalization.', 'Gather the counter-evidence file: past wins, hard tasks completed, and compliments stored for when the critic screams. Read it on request.'], 'note': 'Imposter syndrome researchers note it appears precisely in people who are good enough - the competent doubt more, the clueless worry less.'}, {'head': 'Shrink the Task, Grow the Wins', 'steps': ["Split it into rungs: 'be the best' is unprovable, but 'finish this draft', 'record this video', 'send this email' is done by tonight. Do the rung, bank the win.", 'Record the evidence as it happens: a line in a note app after each small finish. Future-you will need it.'], 'note': None}, {'head': 'Change How You Compare', 'steps': ["Compare to your own past, not the highlights: you are a mile from your own January, and one archive photo away from someone else's best day.", 'League-rank worse-case: even if the fear is true, what is the actual damage? Failing a try costs little; never trying costs everything.'], 'note': None}], 'questions': ['What exactly are you doubting - an ability, a decision, or your whole worth?', 'When did you last do something hard that you then completed?', 'Is this doubt attached to a specific upcoming moment?'], 'close': "Tell me the exact thing you doubt and when you next have to face it, and I'll help you build rungs down to today.", 'followup': "That focus helps. The critic is loudest right before you step, so pre-load the evidence: one line on your phone about the last hard thing you finished. Then split tonight's task into one rung you can finish by midnight. Rung done, win banked, critic quieted - repeat daily."}, 'sw': {'lead': 'Kujishuku ni mkosoaji wa ndani akisema kwa nguvu kamili - lakini ni sauti moja, si umati mzima. Mbinu si ujasiri kipofu; ni uthibitisho, maendeleo, na uthibitisho mdogo.', 'sections': [{'head': 'Tenganisha Mkosoaji Na Ukweli', 'steps': ['Andika laumu kama sentensi, halafu liangalie mstari kwa mstari: imekuwa kweli kila mara, au ni mahususi na ya muda?', 'Jenga faili la kuthibitisha: ushindi wa zamani, kazi ngumu, na sifa zilizohifadhiwa. Kisome juu ya ombi.'], 'note': None}, {'head': 'Punguza Kazi, Ongeza Ushindi', 'steps': ["Igawanye katika ngazi: 'kuwa bora' haithibitiki, lakini 'maliza rasimu hii', 'tuma barua pepe hii' ni kazi ya leo.", 'Rekodi uthibitisho unapotokea: mstari kwenye app ya maelezo baada ya kila kumaliza kidogo.'], 'note': None}, {'head': 'Badilisha Njia ya Kulinganisha', 'steps': ['Linganisha na yako ya zamani, si na utukufu wa wengine: uko maili kutoka kwa wewe wa Januari.', 'Tathmini hata mbaya zaidi: kujaribu kushindwa kunagharimu kidogo; kutojaribu kamwe kunagharimu kila kitu.'], 'note': None}], 'questions': ['Una shaka na nini hasa - uwezo, uamuzi, au thamani yako yote?', 'Umaliziaje jambo gumu la mwisho?', 'Shaka hii inahusishwa na wakati ujao maalum?'], 'close': 'Niambie kitu hasa unachokishuku na wakati utakapokabiliana nalo, nami nitakusaidia kujenga ngazi hadi leo.', 'followup': 'Mwelekeo huo unasaidia. Mkosoaji ana sauti kubwa kabla ya hatua, kwa hiyo jaza uthibitisho kabla: mstari mmoja kwenye simu kuhusu jambo gumu ulilomaliza. Halafu gawanya kazi ya leo kuwa ngazi moja utakayomaliza usiku.'}, 'fr': {'lead': "Le doute est le critique intérieur au volume maximum - mais c'est une voix, pas tout le monde. Le contre n'est pas la confiance aveugle; c'est la preuve, le progrès, la petite victoire.", 'sections': [{'head': 'Séparez le critique des faits', 'steps': ['Écrivez la critique comme phrase puis vérifiez ligne à ligne: toujours vraie, ou spécifique et temporaire ?', 'Constituez le dossier de contre-preuves: victoires passées, compliments rangés. Lisez-le à la demande.'], 'note': None}, {'head': 'Réduisez la tâche, augmentez les victoires', 'steps': ["Découpez en barreaux: 'être le meilleur' est improuvable, mais 'finir ce brouillon', 'envoyer cet e-mail' se fait ce soir.", 'Notez la preuve en direct: une ligne après chaque finition.'], 'note': None}, {'head': 'Changez la comparaison', 'steps': ['Comparez à votre propre passé, pas aux highlight: vous êtes à des miles de votre janvier.', 'Pire cas réel: échouer coûte peu; ne jamais tenter coûte tout.'], 'note': None}], 'questions': ['Que doutez-vous exactement ?', 'Quand avez-vous fini quelque chose de dur ?', 'Ce doute est-il lié à un moment précis ?'], 'close': "Dites-moi la chose exactement doutée et le moment, et je construirai les barreaux jusqu'à aujourd'hui.", 'followup': 'Cette précision aide. Le critique hurle avant le pas, donc préchargez la preuve: une ligne sur votre téléphone sur la dernière chose difficile accomplie. Puis découpez la tâche en un barreau finissable ce soir.'}}, 'celebration_success': {'keys': {'en': ['i passed', 'i passed my exam', 'i passed the exam', 'i passed my test', 'i succeeded', 'i did it', 'i made it', 'i finally did it', 'i got the job', 'i got a job offer', 'i was hired', 'i got hired', 'i got accepted', 'i got admitted', 'i got in', 'my results are good', 'great results', 'i got promoted', 'i received the scholarship', 'i aced it', 'i nailed it', 'i got my degree', 'i graduated', 'good news', 'great news', "i'm so happy", 'i am so happy'], 'sw': ['nilipita mtihani', 'nilifaulu', 'nimepata kazi', 'nilikubaliwa', 'nimepandishwa', 'nilishinda', 'nimefanikiwa', 'habari njema', 'nilikamilisha digrii', 'nilifurahika'], 'fr': ["j'ai réussi", "j'ai eu mon examen", "j'ai eu le job", 'embauché', 'embauchée', "j'ai été admis", "j'ai été admise", 'je suis accepté', "j'ai gagné", 'ça y est', "j'ai réussi mon test", 'promu', 'promue', "j'ai eu mon diplôme", 'grande nouvelle']}, 'topics': ['small_celebration_topic', 'achievement_milestone_topic', 'feelings_proud_topic'], 'en': {'lead': "That is genuinely impressive - you worked, and it landed. Before you rush to the next goal, let's bank this win properly, because savoring success is what trains you to repeat it.", 'sections': [{'head': 'Let It Land', 'steps': ["Take a real moment: tell the people who matter, put the date somewhere you'll see, and let the good feeling sit for a day. Success evaporates when you skip the savoring.", "Name the win specifically: 'I passed my exam / got the job' is the headline; add 'because I kept practicing when I wanted to quit' - that is the part to repeat."], 'note': 'Psychologists who study achievement agree: celebration is not vanity, it is memory - it records in your brain that this path works, which is exactly what drives the next attempt.'}, {'head': 'Reward the Work, Not Just the Result', 'steps': ['Treat yourself in proportion: a meal, an item, a day off - sized to the milestone. Small treats for small wins, bigger for big ones, the habit intact.', 'Write what worked: one paragraph on the method that got you here - habits, moments of doubt overcome, help used. It becomes your blueprint.'], 'note': None}, {'head': 'Decide the Next, Not the Next Ten', 'steps': ['Pick one next step: enjoy today fully, then choose a single direction forward. One focused next goal keeps the momentum without the burnout.', 'Be patient with the next climb: every new summit starts from a new base. That is not starting over; it is leveling up.'], 'note': None}], 'questions': ["What exactly did you achieve - and what did it take that you're proud of?", 'How will you celebrate in a way that marks the moment?', 'Is there a next goal already waiting, or are you still in the glow?'], 'close': "Tell me about the win and your next step, and I'll help you lock the momentum in.", 'followup': "That's the way to do it. Bank the moment properly - celebrate on purpose, write the one thing that worked, and choose just one next direction. And enjoy it; you earned this."}, 'sw': {'lead': 'Hili linapendeza kweli - ulifanya kazi, na imefanikiwa. Kabla ya kukimbilia lengo lijalo, tusajili ushindi huu vizuri, kwa sababu kufurahia mafanikio ndio kunakufunza kuyarudia.', 'sections': [{'head': 'Acha Lituike', 'steps': ['Chukua wakati halisi: waambie watu muhimu, weka tarehe mahali utakapoona, na acha furaha ikae siku nzima.', "Taja ushindi hasa: 'nilipita mtihani' ni kichwa; ongeza 'kwa sababu niliendelea kufanya mazoezi' - hiyo ndiyo sehemu ya kurudia."], 'note': None}, {'head': 'Furahia Kazi, Si Matokeo Tu', 'steps': ['Jitunze kwa uwiano: mlo, kitu, siku ya kupumzika - ukubwa unaendana na hatua.', 'Andika kilichofanya kazi: aya moja ya mbinu iliyokuleta hapa - mazoea, nyakati za shaka, msaada uliotumia.'], 'note': None}, {'head': 'Amua Hatua Inayofuata, Si Kumi', 'steps': ['Chagua hatua moja: furahia leo, halafu chagua mwelekeo mmoja.', 'Kuwa na subira kwenye kupanda kujaa: kila kilele kipya huanza kwenye msingi mpya.'], 'note': None}], 'questions': ['Umefikia nini hasa - na ilichukua nini unachojivunia?', 'Utasherehekea vipi kuweka alama?', 'Lengo lijala lipo tayari, au bado kwenye furaha?'], 'close': 'Niambie juu ya ushindi wako na hatua yako ijayo, nami nitakusaidia kufulia mwendo.', 'followup': 'Hiyo ndiyo njia. Weka alama vizuri - sherehekea kwa makusudi, andika kitu kimoja kilichofanya kazi, na chagua mwelekeo mmoja. Na ufurahie; umeistahili.'}, 'fr': {'lead': "C'est réellement impressionnant - vous avez travaillé, et ça a abouti. Avant de courir vers le prochain objectif, marquons cette victoire, car savourer la réussite est ce qui vous apprend à la répéter.", 'sections': [{'head': 'Laissez-la atterrir', 'steps': ['Prenez un vrai moment: prévenez les personnes importantes, notez la date, laissez la joie poser une journée.', "Nommez précisément: 'j'ai eu mon examen' est le titre; ajoutez 'parce que j'ai continué quand je voulais abandonner'."], 'note': None}, {'head': 'Récompensez le travail, pas que le résultat', 'steps': ['Offrez-vous en proportion: un repas, un objet, un jour off - taillé au jalon.', 'Écrivez ce qui a marché: un paragraphe sur la méthode qui vous a amené ici.'], 'note': None}, {'head': 'Choisissez la suite, pas les dix', 'steps': ["Prenez un prochain pas: profitez d'aujourd'hui, puis une seule direction.", "Soyez patient pour la montée suivante: chaque sommet repart d'une nouvelle base."], 'note': None}], 'questions': ["Qu'avez-vous accompli exactement ?", 'Comment allez-vous célébrer ?', 'Un prochain objectif attend-il déjà ?'], 'close': "Parlez de la victoire et de la suite, et je vous aiderai à verrouiller l'élan.", 'followup': "C'est comme ça qu'on fait. Marquez le moment - célébrez à dessein, écrivez ce qui a marché, choisissez une seule direction. Et profitez-en ; vous l'avez mérité."}}, 'curiosity_learning': {'keys': {'en': ['i want to learn', 'i want to know', 'i want to study', 'how do i start', 'how do i learn', "what's the best way to", "i'm curious about", "i'm interested in", 'teach me', 'explain to me', 'i want to get better at', 'i want to improve', 'how do i become', "i'd like to learn", 'i would love to learn', 'what should i learn', 'exciting to learn', 'show me how', 'guide me'], 'sw': ['nataka kujifunza', 'nataka kujua', 'nataka kusoma', 'vipi nianze', 'nifundishe', 'nieleze', 'nina hamu ya kujua', 'nataka kuboreka', 'nawezaje kuwa', 'nipeni njia'], 'fr': ['je veux apprendre', 'je veux savoir', 'je veux étudier', 'comment commencer', 'comment apprendre', 'enseigne-moi', 'explique-moi', 'je suis curieux', 'je suis curieuse', "j'aimerais apprendre", 'comment je deviens', 'guide-moi']}, 'topics': ['curiosity_topic'], 'en': {'lead': 'Wanting to learn something is one of the best-kept secrets - it keeps your mind fast and your options wide. The only mistake is waiting for the perfect plan before taking the first step.', 'sections': [{'head': 'Define a Done Line', 'steps': ["Say what 'done' looks like this month: not 'learn coding', but 'build one small working thing' or 'summarize chapter one'. A done line makes study trackable.", 'Find the minimum start: the smallest version you can do today - one video, one page, one exercise. The first step is always smaller than fear claims.'], 'note': "Learning researchers are unanimous: spaced practice beats cramming, and teaching or using what you learned within 48 hours locks it in - so build a tiny 'use it' step."}, {'head': 'Build the Cycle', 'steps': ['Learn-do-review: read or watch a small piece, use it immediately, then review tomorrow for five minutes. The three-step cycle is worth more than hours of passive reading.', 'Get instructive feedback: show your attempt to someone who knows, or test yourself. Feedback is the difference between practice and practice that works.'], 'note': None}, {'head': 'Protect the Habit', 'steps': ['Small and frequent beats long and rare: twenty focused minutes daily outperforms a four-hour weekend session.', 'Prevent the stalls: when you get stuck, switch, ask, or use a simpler source - never quit on a single hurdle.'], 'note': None}], 'questions': ["What do you want to learn, and what does 'done this month' look like?", 'Have you tried before? If so, what stopped you?', 'What is the smallest version of it you could do today?'], 'close': "Tell me the topic and your done line, and I'll help you lay out the first 7-day cycle.", 'followup': "Perfect start. This week keep it brutally small: one 20-minute session a day, one small 'use it' action, and a 5-minute review each morning. Seven light days beat one heavy day - and tell me how it feels after."}, 'sw': {'lead': 'Kutaka kujifunza ni siri moja bora - kwani inafanya akili iwe wepesi na chaguo kuwa pana. Kosa pekee ni kusubiri mpango mkamilifu kabla ya kuchukua hatua ya kwanza.', 'sections': [{'head': 'Fafanua Mstari wa Kumaliza', 'steps': ["Sema 'kumaliza' kunamaanisha nini mwezi huu: si 'kujifunza programu', bali 'kujenga kitu kimoja kidogo kinachofanya kazi'.", 'Pata mwanzo mdogo zaidi: toleo dogo unaloweza kufanya leo - video moja, ukurasa mmoja, zoezi moja.'], 'note': None}, {'head': 'Jenga Mzunguko', 'steps': ['Jifunze-fanya-pitia: soma kipande kidogo, utumie mara moja, halafu pitia kesho kwa dakika tano.', 'Pata mrejesho wa kufundisha: onyesha jaribio lako kwa mtu anayejua, au jijaribu.'], 'note': None}, {'head': 'Linda Mazoea', 'steps': ['Kidogo na mara kwa mara kinashinda kirefu na rare: dakika ishirini makini kila siku.', 'Zuia vikwazo: ukikwama, badilisha, uliza, au tumia chanzo rahisi - usiondoke kwenye kikwazo kimoja.'], 'note': None}], 'questions': ["Unataka kujifunza nini, na 'kumaliza mwezi huu' kunaonekana vipi?", 'Umejaribu awali? Kama ndiyo, ni nini kilikuzuia?', 'Toleo dogo unaloweza kufanya leo ni nini?'], 'close': 'Niambie mada na mstari wako wa kumaliza, nami nitakusaidia mpango wa mzunguko wa siku 7.', 'followup': "Mwanzo bora. Wiki hii weka kitu kidogo: kikao kimoja cha dakika 20 kwa siku, kitu kimoja cha 'kitumie', na pitia dakika 5 kila asubuhi. Siku saba nyepesi zinashinda siku moja nzito."}, 'fr': {'lead': "Vouloir apprendre est un des meilleurs secrets - ça garde l'esprit rapide et les options ouvertes. La seule erreur est d'attendre le plan parfait avant le premier pas.", 'sections': [{'head': "Définissez la ligne d'arrivée", 'steps': ["Dites ce que 'fait' veut dire ce mois-ci: pas 'apprendre le code', mais 'construire un petit truc qui marche'.", "Trouvez le démarrage minimal: la plus petite version possible aujourd'hui - une vidéo, une page, un exercice."], 'note': None}, {'head': 'Construisez le cycle', 'steps': ['Apprendre-faire-revoir: lisez un petit morceau, utilisez-le aussitôt, revoyez demain cinq minutes.', "Obtenez un retour instructif: montrez votre tentative à quelqu'un qui sait, ou testez-vous."], 'note': None}, {'head': "Protégez l'habitude", 'steps': ['Petit et fréquent bat long et rare: vingt minutes par jour surpassent une session de quatre heures.', "Évitez les blocages: coincé, changez, demandez, prenez une source plus simple - n'abandonnez jamais sur un seul obstacle."], 'note': None}], 'questions': ["Que voulez-vous apprendre, et 'fait ce mois-ci' ressemble à quoi ?", "Avez-vous essayé avant ? Qu'est-ce qui a arrêté ?", "Quelle est la plus petite version pour aujourd'hui ?"], 'close': "Parlez du sujet et de votre ligne d'arrivée, et je poserai le premier cycle de 7 jours.", 'followup': "Excellent départ. Cette semaine, gardez ça minuscule: 20 minutes par jour, une action 'utiliser', 5 minutes de revue le matin. Sept jours légers battent un jour lourd."}}, 'general': {'keys': {'en': [], 'sw': [], 'fr': []}, 'topics': [], 'en': {'lead': "Let's slow this down and untangle it together - whatever is weighing on you, the way to calm it is to turn it from a heavy fog into a small, workable next step.", 'sections': [{'head': 'Untangle It on Paper', 'steps': ['Say the whole thing out loud or write it down in one go: naming the problem fully is the first and biggest release.', 'Find the one piece you can touch: of everything you wrote, what is the smallest part you could act on this week? That is your handle.'], 'note': None}, {'head': 'Take the Tiny Step', 'steps': ['Do the small thing on purpose: once started, most problems feel 50% lighter - motion rewrites the mood.', 'Reach out to one person: whatever it is, you are not required to carry it silently. One honest conversation changes the shape of it.'], 'note': None}, {'head': 'Protect Tomorrow From Today', 'steps': ['Schedule a break inside the struggle: even a hard week needs one protected hour - a walk, a meal, a call with a friend.', 'Check the basics: sleep, water, food. A depleted body makes every problem look twice as big - restoring the basics restores the scale.'], 'note': None}], 'questions': ['What is the heavy thing, stated in one sentence?', 'What is one small piece of it you could act on this week?', 'Who could you talk to about it without fear of judgment?'], 'close': "Tell me the one-sentence version, and I'll help you turn it into this week's smallest step.", 'followup': 'Thank you for telling me - saying it out loud already unloads some weight. This week, do just the smallest piece and check your basics: sleep, food, water, one real conversation. Small steps, honestly repeated, are how big weights get carried.'}, 'sw': {'lead': 'Tupunguze mwendo na tufumue pamoja - chochote kinachokulemea, njia ya kukituliza ni kuugeuza kutoka ukungu mzito hadi hatua ndogo inayofanya kazi.', 'sections': [{'head': 'Fumua Kwenye Karatasi', 'steps': ['Semaa kila kitu au kiandike mara moja: kutaja tatizo kamili ni kutolewa kubwa kwanza.', 'Pata kipande kimoja unachoweza kugusa: je, ni sehemu gani ndogo unayoweza kuifanya wiki hii?'], 'note': None}, {'head': 'Chukua Hatua Ndogo', 'steps': ['Fanya kitu kidogo kwa makusudi: kikiwa kimeanza, matatizo mengi hupungua - mwendo unabadilisha hisia.', 'Fikia mtu mmoja: chochote niwe, haukupaswa kuibeba kwa ukimya. Mazungumzo moja ya kweli yanabadilisha sura.'], 'note': None}, {'head': 'Linda Kesho Kutoka Leo', 'steps': ['Panga pumziko ndani ya shida: hata wiki ngumu inahitaji saa moja iliyolindwa.', 'Angalia misingi: usingizi, maji, chakula. Mwili uliochoka hufanya kila tatizo lionekane maradufu.'], 'note': None}], 'questions': ['Jambo zito, kwa sentensi moja ni nini?', 'Kipande kimoja kidogo unachoweza kufanya wiki hii ni nini?', 'Nani unaweza kuzungumza naye bila hofu ya kuhukumiwa?'], 'close': 'Niambie sentensi moja, nami nitakusaidia kuigeuza kuwa hatua ndogo ya wiki hii.', 'followup': 'Asante kwa kuniambia - kusema kwa sauti tayari kunapunguza uzito. Wiki hii, fanya kipande kidogo tu na angalia misingi: usingizi, chakula, maji, mazungumzo moja ya kweli.'}, 'fr': {'lead': "Ralentissons et démêlons ensemble - quelle que soit la charge, la façon de la calmer est de la transformer d'un brouillard lourd en une petite étape faisable.", 'sections': [{'head': 'Démêlez sur papier', 'steps': ["Dites tout à voix haute ou écrivez-le d'un coup: nommer le problème complètement est le premier gros soulagement.", 'Trouvez la pièce touchable: quelle est la plus petite partie actionnable cette semaine ?'], 'note': None}, {'head': 'Faites le petit pas', 'steps': ['Faites la petite chose à dessein: une fois commencé, la plupart des problèmes semblent à moitié plus légers.', "Rejoignez une personne: vous n'êtes pas obligé de porter seul. Une conversation honnête change la forme."], 'note': None}, {'head': "Protégez demain d'aujourd'hui", 'steps': ["Planifiez une pause dans la lutte: même une semaine dure a besoin d'une heure protégée.", 'Vérifiez les bases: sommeil, eau, nourriture. Un corps vidé double la taille des problèmes.'], 'note': None}], 'questions': ['Quelle est la chose lourde, en une phrase ?', 'Quel petit morceau pouvez-vous faire cette semaine ?', 'À qui pourriez-vous en parler sans jugement ?'], 'close': "Donnez la version en une phrase, et je l'aurai transformée en plus petit pas.", 'followup': "Merci de l'avoir dit - le dire allège déjà. Cette semaine, faites juste la plus petite pièce et vérifiez les bases: sommeil, nourriture, eau, une vraie conversation."}}}
